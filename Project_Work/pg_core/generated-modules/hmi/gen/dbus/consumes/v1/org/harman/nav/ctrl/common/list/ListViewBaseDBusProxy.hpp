 ...
 *   appropriate enum.
 */
#ifndef V1_ORG_HARMAN_NAV_CTRL_COMMON_LIST_List_View_Base_DBUS_PROXY_HPP_
#define V1_ORG_HARMAN_NAV_CTRL_COMMON_LIST_List_View_Base_DBUS_PROXY_HPP_

#include <v1/org/harman/nav/ctrl/common/list/ListViewBaseProxyBase.hpp>
#include "v1/org/harman/nav/ctrl/common/list/ListViewBaseDBusDeployment.hpp"
...
class ListViewBaseDBusProxy
    : virtual public ListViewBaseProxyBase, 
      virtual public CommonAPI::DBus::DBusProxy {
public:
    ListViewBaseDBusProxy(
        const CommonAPI::DBus::DBusAddress &_address,
        const std::shared_ptr<CommonAPI::DBus::DBusProxyConnection> &_connection);

    virtual ~ListViewBaseDBusProxy() { }
     ...
     */
    virtual void getListSize(const ::org::harman::nav::ctrl::common::list::ListTypes::ListId &_list, CommonAPI::CallStatus &_internalCallStatus, ::org::harman::nav::ctrl::common::list::ListTypes::ListError &_error, ::org::harman::nav::ctrl::common::list::ListTypes::ListSize &_size, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> getListSizeAsync(const ::org::harman::nav::ctrl::common::list::ListTypes::ListId &_list, GetListSizeAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
    ...
    virtual std::future<CommonAPI::CallStatus> createViewAsync(const ::org::harman::nav::ctrl::common::list::ListTypes::ListId &_list, const ::org::harman::nav::ctrl::common::list::ListTypes::ViewSize &_viewsize, CreateViewAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
     * description: delete the given view instance
     */
    virtual void deleteView(const ::org::harman::nav::ctrl::common::list::ListTypes::ViewId &_view, CommonAPI::CallStatus &_internalCallStatus, ::org::harman::nav::ctrl::common::list::ListTypes::ListError &_error, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> deleteViewAsync(const ::org::harman::nav::ctrl::common::list::ListTypes::ViewId &_view, DeleteViewAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
     ...
     *   receive an update.
     */
    virtual void setViewSize(const ::org::harman::nav::ctrl::common::list::ListTypes::ViewId &_view, const ::org::harman::nav::ctrl::common::list::ListTypes::ViewSize &_new_size, CommonAPI::CallStatus &_internalCallStatus, ::org::harman::nav::ctrl::common::list::ListTypes::ListError &_error, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> setViewSizeAsync(const ::org::harman::nav::ctrl::common::list::ListTypes::ViewId &_view, const ::org::harman::nav::ctrl::common::list::ListTypes::ViewSize &_new_size, SetViewSizeAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
...
private:
    ...
    CommonAPI::DBus::DBusEvent<ViewUpdateEvent, CommonAPI::Deployable<::org::harman::nav::ctrl::common::list::ListTypes::ViewId, CommonAPI::EmptyDeployment>, CommonAPI::Deployable<::org::harman::nav::ctrl::common::list::ListTypes::ListSize, CommonAPI::EmptyDeployment>, CommonAPI::Deployable<bool, CommonAPI::EmptyDeployment>, CommonAPI::Deployable<bool, CommonAPI::EmptyDeployment>> viewUpdate_;
    CommonAPI::DBus::DBusEvent<ListSizeEvent, CommonAPI::Deployable<::org::harman::nav::ctrl::common::list::ListTypes::ListId, ::org::harman::nav::ctrl::common::list::ListTypes_::ListIdDeployment_t>, CommonAPI::Deployable<::org::harman::nav::ctrl::common::list::ListTypes::ListSize, CommonAPI::EmptyDeployment>> listSize_;
...
#endif // V1_ORG_HARMAN_NAV_CTRL_COMMON_LIST_List_View_Base_DBUS_PROXY_HPP_
