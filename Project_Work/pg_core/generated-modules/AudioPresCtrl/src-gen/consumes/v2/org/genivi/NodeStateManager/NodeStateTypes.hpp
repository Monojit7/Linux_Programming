...
struct NodeStateTypes {
    ...
    struct NsmSessionState : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            ...
            NsmSessionState_HourMode = 3,
            NsmSessionState_Standby = 4,
            NsmSessionState_Shutdown = 5
        };
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::NsmSessionState_HourMode):
                case static_cast<int32_t>(Literal::NsmSessionState_Standby):
                case static_cast<int32_t>(Literal::NsmSessionState_Shutdown):
                return true;
            default:
                return false;
            }
