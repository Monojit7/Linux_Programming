...
*/
#ifndef V1_COM_HARMAN_MMPRES_Media_Browser_STUB_DEFAULT_HPP_
#define V1_COM_HARMAN_MMPRES_Media_Browser_STUB_DEFAULT_HPP_
...
public:
     ...
     *   filter categories.
     */
    virtual void playSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap _filterIDs, playSessionReply_t _reply);
    /**
     ...
     */
    virtual void gotoNowplayingLevel(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint64_t _mediumID, gotoNowplayingLevelReply_t _reply);
...
#endif // V1_COM_HARMAN_MMPRES_Media_Browser_STUB_DEFAULT
