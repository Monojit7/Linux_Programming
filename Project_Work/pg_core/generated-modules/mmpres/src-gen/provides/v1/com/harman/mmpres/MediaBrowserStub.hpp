...
*/
#ifndef V1_COM_HARMAN_MMPRES_Media_Browser_STUB_HPP_
#define V1_COM_HARMAN_MMPRES_Media_Browser_STUB_HPP_
...
{
public:
    typedef std::function<void (uint32_t _sessionID, ::v1::com::harman::mmpres::MMPresTypes::eCallResult _result)>openSessionReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result)>closeSessionReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result)>cancelSessionReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numResults, uint32_t _sessionQueryID)>setSessionQueryReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result)>setSessionQueryWindowReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numResults, uint32_t _sessionQueryID)>gotoPreviousSessionQueryReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numResults)>jumpToSessionQueryReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result)>playSessionReply_t;
    typedef std::function<void (::v1::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numItems, uint32_t _sessionQueryID)>gotoNowplayingLevelReply_t;
    ...
    virtual void playSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap _filterIDs, playSessionReply_t _reply) = 0;
    /**
    ...
    virtual void gotoNowplayingLevel(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint64_t _mediumID, gotoNowplayingLevelReply_t _reply) = 0;
    /**
     ...
     * If no ClientIds are given, the selective broadcast is sent to all subscribed clients.
     */
    virtual void fireSessionQueryWindowUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v1::com::harman::mmpres::MMPresTypes::eQueryStatus &_status, const uint64_t &_startIndex, const uint64_t &_numItems, const ::v1::com::harman::mmpres::MMPresTypes::MetadataItemList &_itemList, const bool &_windowContainsCurrentlyPlayingTrack, const uint64_t &_itemIndexTobeHighlighted, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
...
#endif // V1_COM_HARMAN_MMPRES_Media_Browser_STUB_HPP_
