...
_result = deploy_result.getValue();
    ...
    void MediaBrowserDBusProxy::setSessionQuery(const uint32_t &_sessionID, const uint64_t &_mediumID, const ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v1::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v1::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v1::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_mediumID(_mediumID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        ...
        *this,
        ...
        "uta{it}a{is}iuuibbu",
(_info ? _info : &CommonAPI::DBus::defaultCallInfo),
deploy_sessionID, deploy_mediumID, deploy_filterIDs, deploy_filters, deploy_resultType, deploy_metadataAttributes, deploy_metadataCountTypes, deploy_type, deploy_resetPrevious, deploy_AutoUpdateEnabled, deploy_ContentMask,
_internalCallStatus,
deploy_result, deploy_numResults, deploy_sessionQueryID);
_result = deploy_result.getValue();
_numResults = deploy_numResults.getValue();
_sessionQueryID = deploy_sessionQueryID.getValue();
}
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::setSessionQueryAsync(const uint32_t &_sessionID, const uint64_t &_mediumID, const ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v1::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v1::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v1::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, SetSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_mediumID(_mediumID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::FilterIDMap, ::v1::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t> deploy_filterIDs(_filterIDs, static_cast<::v1::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::FilterMap, ::v1::com::harman::mmpres::MMPresTypes_::FilterMapDeployment_t> deploy_filters(_filters, static_cast<::v1::com::harman::mmpres::MMPresTypes_::FilterMapDeployment_t*>(nullptr));
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID, deploy_mediumID, deploy_filterIDs, deploy_filters, deploy_resultType, deploy_metadataAttributes, deploy_metadataCountTypes, deploy_type, deploy_resetPrevious, deploy_AutoUpdateEnabled, deploy_ContentMask,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numResults, CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> _sessionQueryID) {
        	if (_callback)
        		_callback(_internalCallStatus, _result.getValue(), _numResults.getValue(), _sessionQueryID.getValue());
        },
        std::make_tuple(deploy_result, deploy_numResults, deploy_sessionQueryID));
    }
    /**
...
_result = deploy_result.getValue();
     ...
     */
    void MediaBrowserDBusProxy::gotoPreviousSessionQuery(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_numResults(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionQueryID(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_sessionQueryID = deploy_sessionQueryID.getValue();
     ...
     */
    void MediaBrowserDBusProxy::jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionQueryID(_sessionQueryID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_numResults(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_internalCallStatus,
deploy_result, deploy_numResults);
_result = deploy_result.getValue();
_numResults = deploy_numResults.getValue();
}
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::jumpToSessionQueryAsync(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, JumpToSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID, deploy_sessionQueryID,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numResults) {
        	if (_callback)
        		_callback(_internalCallStatus, _result.getValue(), _numResults.getValue());
        },
        std::make_tuple(deploy_result, deploy_numResults));
    }
    /**
...
_result = deploy_result.getValue();
     ...
     */
    void MediaBrowserDBusProxy::gotoNowplayingLevel(const uint32_t &_sessionID, const uint64_t &_mediumID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_mediumID(_mediumID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        ...
        *this,
        ...
        "ut",
(_info ? _info : &CommonAPI::DBus::defaultCallInfo),
deploy_sessionID, deploy_mediumID,
_internalCallStatus,
...
_sessionQueryID = deploy_sessionQueryID.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::gotoNowplayingLevelAsync(const uint32_t &_sessionID, const uint64_t &_mediumID, GotoNowplayingLevelAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_mediumID(_mediumID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_numItems(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
