...
public:
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const uint32_t&)> SetSessionQueryAsyncCallback;
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const uint32_t&)> GotoPreviousSessionQueryAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&)> JumpToSessionQueryAsyncCallback;
     ...
     */
    virtual void gotoPreviousSessionQuery(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void gotoNowplayingLevel(const uint32_t &_sessionID, const uint64_t &_mediumID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> gotoNowplayingLevelAsync(const uint32_t &_sessionID, const uint64_t &_mediumID, GotoNowplayingLevelAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
};
