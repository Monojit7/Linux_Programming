...
*/
#ifndef V1_COM_HARMAN_MMPRES_Media_Browser_PROXY_BASE_HPP_
#define V1_COM_HARMAN_MMPRES_Media_Browser_PROXY_BASE_HPP_
...
public:
    ...
    typedef CommonAPI::SelectiveEvent<uint32_t, uint32_t, ::v1::com::harman::mmpres::MMPresTypes::eQueryStatus, uint64_t, uint64_t, ::v1::com::harman::mmpres::MMPresTypes::MetadataItemList, bool, uint64_t> SessionQueryWindowUpdateSelectiveEvent;
    ...
    typedef CommonAPI::SelectiveEvent<uint32_t, uint32_t, ::v1::com::harman::mmpres::MMPresTypes::arAlphaIndex> SessionQueryAlphaJumpUpdateSelectiveEvent;

    typedef std::function<void(const CommonAPI::CallStatus&, const uint32_t&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&)> OpenSessionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&)> CloseSessionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&)> CancelSessionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const uint32_t&, const std::string&)> SetSessionQueryAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&)> SetSessionQueryWindowAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const uint32_t&, const ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel&, const std::string&)> GotoPreviousSessionQueryAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const std::string&)> JumpToSessionQueryAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&)> PlaySessionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&)> GotoTrackAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const uint32_t&)> GotoNowplayingLevelAsyncCallback;
     ...
     */
    virtual void openSession(CommonAPI::CallStatus &_internalCallStatus, uint32_t &_sessionID, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void closeSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void cancelSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void setSessionQueryWindow(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void playSession(const uint32_t &_sessionID, const ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> playSessionAsync(const uint32_t &_sessionID, const ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, PlaySessionAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info = nullptr) = 0;
...
#endif // V1_COM_HARMAN_MMPRES_Media_Browser_PROXY_BASE_HPP_
