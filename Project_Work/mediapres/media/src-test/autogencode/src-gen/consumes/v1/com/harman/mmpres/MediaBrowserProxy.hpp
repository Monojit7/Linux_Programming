...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info = nullptr);
    /**
...
void MediaBrowserProxy<_AttributeExtensions...>::setSessionQuery(const uint32_t &_sessionID, const uint8_t &_slotId, const ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v1::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v1::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v1::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info) {
    ...
    delegate_->setSessionQuery(_sessionID, _slotId, _filterIDs, _filters, _resultType, _metadataAttributes, _metadataCountTypes, _type, _resetPrevious, _AutoUpdateEnabled, _ContentMask, _internalCallStatus, _result, _numResults, _sessionQueryID, _breadcrumbpath, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::setSessionQueryAsync(const uint32_t &_sessionID, const uint8_t &_slotId, const ::v1::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v1::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v1::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v1::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, SetSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    if (!_resultType.validate()) {
        ...
        _callback(CommonAPI::CallStatus::INVALID_VALUE, result, numResults, sessionQueryID, breadcrumbpath);
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoPreviousSessionQuery(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel &_browselevel, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info) {
    delegate_->gotoPreviousSessionQuery(_sessionID, _internalCallStatus, _result, _numResults, _sessionQueryID, _browselevel, _breadcrumbpath, _info);
}
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info) {
...
struct DefaultAttributeProxyHelper<::v1::com::harman::mmpres::MediaBrowserProxy,
    _AttributeExtension> {
    typedef typename ::v1::com::harman::mmpres::MediaBrowserProxy<
            ::v1::com::harman::mmpres::MediaBrowserExtensions::SearchCandidatesAttributeExtension<_AttributeExtension>
    > class_t;
};
}
