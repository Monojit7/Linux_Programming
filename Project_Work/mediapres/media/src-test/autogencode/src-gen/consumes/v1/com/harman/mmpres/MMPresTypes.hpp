...
struct MMPresTypes {
    ...
    struct eSyncState : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            STATE_UNKNOWN = 0,
            STATE_FIRST_FILE_SYNCED = 1,
            STATE_FILE_PASS_SYNCED = 2,
            STATE_METADATA_PASS_SYNCED = 3,
            STATE_PLAYLIST_PASS_SYNCED = 4,
            STATE_THUMBNAIL_PASS_SYNCED = 5,
            STATE_GRACENOTE_PASS_SYNCED = 6
        };
    ...
    typedef std::unordered_map<uint8_t, ::v1::com::harman::mmpres::MMPresTypes::eSyncState> SyncMap;
    ...
    typedef std::unordered_map<::v1::com::harman::mmpres::MMPresTypes::eTitleContentType, uint64_t, CommonAPI::EnumHasher<::v1::com::harman::mmpres::MMPresTypes::eTitleContentType>> ContentInfoMap;
    ...
    struct eMetadataType : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            ...
            METADATATYPE_REMOTECD_MP3 = 17,
            METADATATYPE_REMOTECD_CDDA = 18
        };
    ...
    typedef std::unordered_map<::v1::com::harman::mmpres::MMPresTypes::eTitleContentType, ::v1::com::harman::mmpres::MMPresTypes::MetadataCountMap, CommonAPI::EnumHasher<::v1::com::harman::mmpres::MMPresTypes::eTitleContentType>> BrowseCategoryMap;
    ...
    typedef std::unordered_map<uint8_t, ::v1::com::harman::mmpres::MMPresTypes::eMediaError> MediaErrorMap;
...
namespace std {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eRemotePlayerCapability> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eRemotePlayerCapability& eRemotePlayerCapability) const {
    ...
    //Hash for eSyncState
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eSyncState> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eSyncState& eSyncState) const {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eBTMediaProfile> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eBTMediaProfile& eBTMediaProfile) const {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel& ePrevBrowseLevel) const {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eMediaError> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eMediaError& eMediaError) const {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::ePlaybackSpeed> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::ePlaybackSpeed& ePlaybackSpeed) const {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eAudioChannelStatus> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eAudioChannelStatus& eAudioChannelStatus) const {
            return static_cast<int32_t>(eAudioChannelStatus);
        }
    };
    //Hash for eSubtitleStatus
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eSubtitleStatus> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eSubtitleStatus& eSubtitleStatus) const {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eRemoteCDDiscStatus> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eRemoteCDDiscStatus& eRemoteCDDiscStatus) const {
            return static_cast<int32_t>(eRemoteCDDiscStatus);
        }
    };
    //Hash for eRemoteCDError
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eRemoteCDError> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eRemoteCDError& eRemoteCDError) const {
            return static_cast<int32_t>(eRemoteCDError);
        }
    };
    //Hash for eRemoteCDHardwareError
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::eRemoteCDHardwareError> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::eRemoteCDHardwareError& eRemoteCDHardwareError) const {
