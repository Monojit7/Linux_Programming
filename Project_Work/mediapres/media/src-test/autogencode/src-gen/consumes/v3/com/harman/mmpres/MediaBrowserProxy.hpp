...
*/
#ifndef V3_COM_HARMAN_MMPRES_Media_Browser_PROXY_HPP_
#define V3_COM_HARMAN_MMPRES_Media_Browser_PROXY_HPP_

#include <v3/com/harman/mmpres/MediaBrowserProxyBase.hpp>
...
public:
    ...
    /**
     * Returns the wrapper class that provides access to the attribute searchCandidates.
     */
    virtual SearchCandidatesAttribute& getSearchCandidatesAttribute() {
        return delegate_->getSearchCandidatesAttribute();
    }
     ...
     */
    /**
     * Returns the wrapper class that provides access to the broadcast thumbnailListUpdate.
     */
    virtual ThumbnailListUpdateSelectiveEvent& getThumbnailListUpdateSelectiveEvent() {
        return delegate_->getThumbnailListUpdateSelectiveEvent();
    }
    /**
     * description: Publishes the query status to all clients. The client can get the data once the
     *   query is "finished" 	 	     returns  sessionID: 	   The Session ID alloted.   
     ...
     */
    /**
     * Returns the wrapper class that provides access to the broadcast sessionQueryAlphaJumpUpdate.
     */
    virtual SessionQueryAlphaJumpUpdateSelectiveEvent& getSessionQueryAlphaJumpUpdateSelectiveEvent() {
        return delegate_->getSessionQueryAlphaJumpUpdateSelectiveEvent();
    }
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void openSession(CommonAPI::CallStatus &_internalCallStatus, uint32_t &_sessionID, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void closeSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void cancelSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void setSessionQueryWindow(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void playSession(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> playSessionAsync(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, PlaySessionAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * Calls gotoTrack with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls gotoTrack with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> gotoTrackAsync(const uint64_t &_trackPosition, GotoTrackAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> gotoNowplayingLevelAsync(const uint32_t &_sessionID, const uint8_t &_slotId, GotoNowplayingLevelAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     *   config file.
     * Calls getElevatorBarHelperLetterTimeout with synchronous semantics.
     * 
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     * "SUCCESS" or which type of error has occurred. In case of an error, ONLY the CallStatus
     * will be set.
     */
    virtual void getElevatorBarHelperLetterTimeout(CommonAPI::CallStatus &_internalCallStatus, float &_timeout, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls getElevatorBarHelperLetterTimeout with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> getElevatorBarHelperLetterTimeoutAsync(GetElevatorBarHelperLetterTimeoutAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
...
namespace MediaBrowserExtensions {
    template <template <typename > class _ExtensionType>
    class SearchCandidatesAttributeExtension {
     public:
        typedef _ExtensionType<MediaBrowserProxyBase::SearchCandidatesAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<MediaBrowserProxyBase::SearchCandidatesAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        SearchCandidatesAttributeExtension() {}
    #endif
    
        SearchCandidatesAttributeExtension(MediaBrowserProxyBase& proxy): attributeExtension_(proxy.getSearchCandidatesAttribute()) {
        }
    
        inline extension_type& getSearchCandidatesAttributeExtension() {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::openSession(CommonAPI::CallStatus &_internalCallStatus, uint32_t &_sessionID, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::closeSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::cancelSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
...
void MediaBrowserProxy<_AttributeExtensions...>::setSessionQuery(const uint32_t &_sessionID, const uint8_t &_slotId, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v3::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, std::string &_breadcrumbpath, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_lresultType, const CommonAPI::CallInfo *_info) {
    ...
    delegate_->setSessionQuery(_sessionID, _slotId, _filterIDs, _filters, _resultType, _metadataAttributes, _metadataCountTypes, _type, _resetPrevious, _AutoUpdateEnabled, _ContentMask, _internalCallStatus, _result, _numResults, _sessionQueryID, _breadcrumbpath, _lresultType, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::setSessionQueryAsync(const uint32_t &_sessionID, const uint8_t &_slotId, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v3::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, SetSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    if (!_resultType.validate()) {
        ...
        _callback(CommonAPI::CallStatus::INVALID_VALUE, result, numResults, sessionQueryID, breadcrumbpath, lresultType);
    ...
    return delegate_->setSessionQueryAsync(_sessionID, _slotId, _filterIDs, _filters, _resultType, _metadataAttributes, _metadataCountTypes, _type, _resetPrevious, _AutoUpdateEnabled, _ContentMask, _callback, _info);
}
/**
 * description: Ask presentation control to fetch the desired set of entries for a particular
 *   session query. This call does not block for the result to complete, and will
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::setSessionQueryWindow(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoPreviousSessionQuery(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, ::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel &_browselevel, std::string &_breadcrumbpath, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const CommonAPI::CallInfo *_info) {
    delegate_->gotoPreviousSessionQuery(_sessionID, _internalCallStatus, _result, _numResults, _sessionQueryID, _browselevel, _breadcrumbpath, _resultType, _info);
}
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info) {
    delegate_->jumpToSessionQuery(_sessionID, _sessionQueryID, _internalCallStatus, _result, _numResults, _breadcrumbpath, _info);
}
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::playSession(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
    delegate_->playSession(_sessionID, _filterIDs, _internalCallStatus, _result, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::playSessionAsync(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, PlaySessionAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
    delegate_->gotoTrack(_trackPosition, _internalCallStatus, _result, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::gotoTrackAsync(const uint64_t &_trackPosition, GotoTrackAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->gotoTrackAsync(_trackPosition, _callback, _info);
}
/**
 * description: This requests the pres to directly jump to the file system level or metadata
 *   browse path level which                     contains the currently playing
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info) {
    delegate_->gotoNowplayingLevel(_sessionID, _slotId, _internalCallStatus, _result, _numItems, _sessionQueryID, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::gotoNowplayingLevelAsync(const uint32_t &_sessionID, const uint8_t &_slotId, GotoNowplayingLevelAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->gotoNowplayingLevelAsync(_sessionID, _slotId, _callback, _info);
}
/**
 * description: This requests the Media pres to get timeout value to show helper letter of
 *   Elevator bar. 	                     timeout: This value is obtained from media
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::getElevatorBarHelperLetterTimeout(CommonAPI::CallStatus &_internalCallStatus, float &_timeout, const CommonAPI::CallInfo *_info) {
    delegate_->getElevatorBarHelperLetterTimeout(_internalCallStatus, _timeout, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::getElevatorBarHelperLetterTimeoutAsync(GetElevatorBarHelperLetterTimeoutAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->getElevatorBarHelperLetterTimeoutAsync(_callback, _info);
}
...
struct DefaultAttributeProxyHelper<::v3::com::harman::mmpres::MediaBrowserProxy,
    _AttributeExtension> {
    typedef typename ::v3::com::harman::mmpres::MediaBrowserProxy<
            ::v3::com::harman::mmpres::MediaBrowserExtensions::SearchCandidatesAttributeExtension<_AttributeExtension>
    > class_t;
};
}
...
#endif // V3_COM_HARMAN_MMPRES_Media_Browser_PROXY_HPP_
