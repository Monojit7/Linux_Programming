...
*/
#ifndef V3_COM_HARMAN_MMPRES_Media_Browser_DBUS_PROXY_HPP_
#define V3_COM_HARMAN_MMPRES_Media_Browser_DBUS_PROXY_HPP_
...
public:
     ...
     */
    virtual void openSession(CommonAPI::CallStatus &_internalCallStatus, uint32_t &_sessionID, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
     ...
     */
    virtual void closeSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
     ...
     */
    virtual void cancelSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
     ...
     */
    virtual void setSessionQueryWindow(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
     ...
     */
    virtual void jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info);
     ...
     */
    virtual void playSession(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> playSessionAsync(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, PlaySessionAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
     ...
     */
    virtual void gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
     ...
     */
    virtual void gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info);
     ...
     *   config file.
     */
    virtual void getElevatorBarHelperLetterTimeout(CommonAPI::CallStatus &_internalCallStatus, float &_timeout, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> getElevatorBarHelperLetterTimeoutAsync(GetElevatorBarHelperLetterTimeoutAsyncCallback _callback, const CommonAPI::CallInfo *_info);
...
#endif // V3_COM_HARMAN_MMPRES_Media_Browser_DBUS_PROXY_HPP_
