...
*/
#include <v3/com/harman/mmpres/MediaBrowserDBusProxy.hpp>
...
,		sessionQueryUpdateSelective_(*this, "sessionQueryUpdate", "uut", std::make_tuple(static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr))),
		...
		sessionQueryAlphaJumpUpdateSelective_(*this, "sessionQueryAlphaJumpUpdate", "uua(su)", std::make_tuple(static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<::v3::com::harman::mmpres::MMPresTypes_::arAlphaIndexDeployment_t*>(nullptr)))
{
}
...
MediaBrowserDBusProxy::SessionQueryAlphaJumpUpdateSelectiveEvent& MediaBrowserDBusProxy::getSessionQueryAlphaJumpUpdateSelectiveEvent() {
     ...
     */
    void MediaBrowserDBusProxy::openSession(CommonAPI::CallStatus &_internalCallStatus, uint32_t &_sessionID, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
...
_result = deploy_result.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::openSessionAsync(OpenSessionAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        "",
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> _sessionID, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result) {
        	if (_callback)
     ...
     */
    void MediaBrowserDBusProxy::closeSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
...
_result = deploy_result.getValue();
     ...
     */
    void MediaBrowserDBusProxy::cancelSession(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
...
_result = deploy_result.getValue();
    ...
    void MediaBrowserDBusProxy::setSessionQuery(const uint32_t &_sessionID, const uint8_t &_slotId, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v3::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, std::string &_breadcrumbpath, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_lresultType, const CommonAPI::CallInfo *_info) {
        ...
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::FilterIDMap, ::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t> deploy_filterIDs(_filterIDs, static_cast<::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::FilterMap, ::v3::com::harman::mmpres::MMPresTypes_::FilterMapDeployment_t> deploy_filters(_filters, static_cast<::v3::com::harman::mmpres::MMPresTypes_::FilterMapDeployment_t*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType, CommonAPI::EmptyDeployment> deploy_resultType(_resultType, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        ...
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes, CommonAPI::EmptyDeployment> deploy_type(_type, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        ...
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType, CommonAPI::EmptyDeployment> deploy_lresultType(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment >,
            CommonAPI::Deployable<uint8_t, CommonAPI::EmptyDeployment >,
            CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::FilterIDMap, ::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t >,
            CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::FilterMap, ::v3::com::harman::mmpres::MMPresTypes_::FilterMapDeployment_t >,
            CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType, CommonAPI::EmptyDeployment >,
            CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment >,
            CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment >,
            CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes, CommonAPI::EmptyDeployment >,
...
_internalCallStatus,
deploy_result, deploy_numResults, deploy_sessionQueryID, deploy_breadcrumbpath, deploy_lresultType);
_result = deploy_result.getValue();
...
_lresultType = deploy_lresultType.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::setSessionQueryAsync(const uint32_t &_sessionID, const uint8_t &_slotId, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, const ::v3::com::harman::mmpres::MMPresTypes::FilterMap &_filters, const ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const uint32_t &_metadataAttributes, const uint32_t &_metadataCountTypes, const ::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes &_type, const bool &_resetPrevious, const bool &_AutoUpdateEnabled, const uint32_t &_ContentMask, SetSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID, deploy_slotId, deploy_filterIDs, deploy_filters, deploy_resultType, deploy_metadataAttributes, deploy_metadataCountTypes, deploy_type, deploy_resetPrevious, deploy_AutoUpdateEnabled, deploy_ContentMask,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numResults, CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> _sessionQueryID, CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> _breadcrumbpath, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType, CommonAPI::EmptyDeployment> _lresultType) {
        	if (_callback)
        		_callback(_internalCallStatus, _result.getValue(), _numResults.getValue(), _sessionQueryID.getValue(), _breadcrumbpath.getValue(), _lresultType.getValue());
        },
        std::make_tuple(deploy_result, deploy_numResults, deploy_sessionQueryID, deploy_breadcrumbpath, deploy_lresultType));
    }
    /**
     ...
     */
    void MediaBrowserDBusProxy::setSessionQueryWindow(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_result = deploy_result.getValue();
     ...
     */
    void MediaBrowserDBusProxy::gotoPreviousSessionQuery(const uint32_t &_sessionID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, uint32_t &_sessionQueryID, ::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel &_browselevel, std::string &_breadcrumbpath, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType &_resultType, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_numResults(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionQueryID(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel, CommonAPI::EmptyDeployment> deploy_browselevel(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> deploy_breadcrumbpath(static_cast<CommonAPI::DBus::StringDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType, CommonAPI::EmptyDeployment> deploy_resultType(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment >
            >,
            ...
            CommonAPI::Deployable<uint64_t,CommonAPI::EmptyDeployment>,
            CommonAPI::Deployable<uint32_t,CommonAPI::EmptyDeployment>,
            CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel,CommonAPI::EmptyDeployment>,
            CommonAPI::Deployable<std::string,CommonAPI::DBus::StringDeployment>,
            CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType,CommonAPI::EmptyDeployment>
            >
        	>::callMethodWithReply(
...
deploy_sessionID,
_internalCallStatus,
deploy_result, deploy_numResults, deploy_sessionQueryID, deploy_browselevel, deploy_breadcrumbpath, deploy_resultType);
_result = deploy_result.getValue();
_numResults = deploy_numResults.getValue();
_sessionQueryID = deploy_sessionQueryID.getValue();
_browselevel = deploy_browselevel.getValue();
_breadcrumbpath = deploy_breadcrumbpath.getValue();
_resultType = deploy_resultType.getValue();
}
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::gotoPreviousSessionQueryAsync(const uint32_t &_sessionID, GotoPreviousSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numResults, CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> _sessionQueryID, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel, CommonAPI::EmptyDeployment> _browselevel, CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> _breadcrumbpath, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eMetadataType, CommonAPI::EmptyDeployment> _resultType) {
        	if (_callback)
        		_callback(_internalCallStatus, _result.getValue(), _numResults.getValue(), _sessionQueryID.getValue(), _browselevel.getValue(), _breadcrumbpath.getValue(), _resultType.getValue());
        },
        std::make_tuple(deploy_result, deploy_numResults, deploy_sessionQueryID, deploy_browselevel, deploy_breadcrumbpath, deploy_resultType));
    }
    /**
     * description: HMI Can use this to do a direct jump to any previous query ids
     */
    void MediaBrowserDBusProxy::jumpToSessionQuery(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numResults, std::string &_breadcrumbpath, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionQueryID(_sessionQueryID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_numResults(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_breadcrumbpath = deploy_breadcrumbpath.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::jumpToSessionQueryAsync(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, JumpToSessionQueryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID, deploy_sessionQueryID,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numResults, CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> _breadcrumbpath) {
        	if (_callback)
     ...
     */
    void MediaBrowserDBusProxy::playSession(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::FilterIDMap, ::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t> deploy_filterIDs(_filterIDs, static_cast<::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
...
_result = deploy_result.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::playSessionAsync(const uint32_t &_sessionID, const ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap &_filterIDs, PlaySessionAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::FilterIDMap, ::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t> deploy_filterIDs(_filterIDs, static_cast<::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        return CommonAPI::DBus::DBusProxyHelper<
     ...
     */
    void MediaBrowserDBusProxy::gotoTrack(const uint64_t &_trackPosition, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
...
_result = deploy_result.getValue();
     ...
     */
    void MediaBrowserDBusProxy::gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint8_t, CommonAPI::EmptyDeployment> deploy_slotId(_slotId, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_sessionQueryID = deploy_sessionQueryID.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::gotoNowplayingLevelAsync(const uint32_t &_sessionID, const uint8_t &_slotId, GotoNowplayingLevelAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID, deploy_slotId,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v3::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numItems, CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> _sessionQueryID) {
        	if (_callback)
     ...
     *   config file.
     */
    void MediaBrowserDBusProxy::getElevatorBarHelperLetterTimeout(CommonAPI::CallStatus &_internalCallStatus, float &_timeout, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<float, CommonAPI::EmptyDeployment> deploy_timeout(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            >,
            CommonAPI::DBus::DBusSerializableArguments<
        	...
        	>::callMethodWithReply(
        *this,
        "getElevatorBarHelperLetterTimeout",
        "",
(_info ? _info : &CommonAPI::DBus::defaultCallInfo),
_internalCallStatus,
deploy_timeout);
_timeout = deploy_timeout.getValue();
}
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::getElevatorBarHelperLetterTimeoutAsync(GetElevatorBarHelperLetterTimeoutAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<float, CommonAPI::EmptyDeployment> deploy_timeout(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        return CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            >,
        ...
        *this,
        ...
        "",
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<float, CommonAPI::EmptyDeployment> _timeout) {
        	if (_callback)
        		_callback(_internalCallStatus, _timeout.getValue());
        },
        std::make_tuple(deploy_timeout));
    }
