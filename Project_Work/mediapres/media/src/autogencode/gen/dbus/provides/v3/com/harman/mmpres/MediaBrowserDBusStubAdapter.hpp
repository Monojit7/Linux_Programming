...
*/
#ifndef V3_COM_HARMAN_MMPRES_Media_Browser_DBUS_STUB_ADAPTER_HPP_
#define V3_COM_HARMAN_MMPRES_Media_Browser_DBUS_STUB_ADAPTER_HPP_

#include <v3/com/harman/mmpres/MediaBrowserStub.hpp>
#include "v3/com/harman/mmpres/MediaBrowserDBusDeployment.hpp"        
...
public:
    ...
    void fireItemIndexTobeHighlightedAttributeChanged(const ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap& value);
     ...
     *   and their index
     */
    void fireSessionQueryAlphaJumpUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> _client, const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::arAlphaIndex &_ajList);
    void sendSessionQueryAlphaJumpUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::arAlphaIndex &_ajList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr);
...
static CommonAPI::DBus::DBusGetAttributeStubDispatcher<
        ::v3::com::harman::mmpres::MediaBrowserStub,
        CommonAPI::Version
...
static CommonAPI::DBus::DBusGetAttributeStubDispatcher<
        ::v3::com::harman::mmpres::MediaBrowserStub,
        ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap,
        ::v3::com::harman::mmpres::MMPresTypes_::HighlightItemIndexMapDeployment_t                
        > getItemIndexTobeHighlightedAttributeStubDispatcher;
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v3::com::harman::mmpres::MediaBrowserStub,
    std::tuple<>,
    std::tuple<uint32_t, ::v3::com::harman::mmpres::MMPresTypes::eCallResult>,
    std::tuple<>,
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v3::com::harman::mmpres::MediaBrowserStub,
    std::tuple<uint32_t, uint8_t, ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap, ::v3::com::harman::mmpres::MMPresTypes::FilterMap, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType, uint32_t, uint32_t, ::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes, bool, bool, uint32_t>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult, uint64_t, uint32_t, std::string, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType>,
    std::tuple<CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, ::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t, ::v3::com::harman::mmpres::MMPresTypes_::FilterMapDeployment_t, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment>,
    std::tuple<CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::DBus::StringDeployment, CommonAPI::EmptyDeployment>
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v3::com::harman::mmpres::MediaBrowserStub,
    std::tuple<uint32_t>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult, uint64_t, uint32_t, ::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel, std::string, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType>,
    std::tuple<CommonAPI::EmptyDeployment>,
    std::tuple<CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment, CommonAPI::DBus::StringDeployment, CommonAPI::EmptyDeployment>
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ...
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult, uint64_t, std::string>,
    std::tuple<CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment>,
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v3::com::harman::mmpres::MediaBrowserStub,
    std::tuple<uint32_t, ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult>,
    std::tuple<CommonAPI::EmptyDeployment, ::v3::com::harman::mmpres::MMPresTypes_::FilterIDMapDeployment_t>,
    std::tuple<CommonAPI::EmptyDeployment>
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ...
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult, uint64_t, uint32_t>,
    std::tuple<CommonAPI::EmptyDeployment, CommonAPI::EmptyDeployment>,
...
static CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ...
    > getElevatorBarHelperLetterTimeoutStubDispatcher;
...
#endif // V3_COM_HARMAN_MMPRES_Media_Browser_DBUS_STUB_ADAPTER_HPP_
