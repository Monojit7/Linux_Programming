...
CommonAPI::DBus::DBusGetAttributeStubDispatcher<
        ::v1::com::harman::mmpres::MediaSettingsStub,
        ::v3::com::harman::mmpres::MMPresTypes::eSubtitleStatus
...
CommonAPI::DBus::DBusGetAttributeStubDispatcher<
        ::v1::com::harman::mmpres::MediaSettingsStub,
        ::v3::com::harman::mmpres::MMPresTypes::eAudioChannelStatus
...
CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v1::com::harman::mmpres::MediaSettingsStub,
    std::tuple<uint8_t>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eMediaError>,
    std::tuple<CommonAPI::EmptyDeployment>,
    std::tuple<CommonAPI::EmptyDeployment>
...
CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v1::com::harman::mmpres::MediaSettingsStub,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eAudioChannelStatus>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult>,
    std::tuple<CommonAPI::EmptyDeployment>,
    std::tuple<CommonAPI::EmptyDeployment>
...
CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v1::com::harman::mmpres::MediaSettingsStub,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eSubtitleStatus>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eCallResult>,
    std::tuple<CommonAPI::EmptyDeployment>,
    std::tuple<CommonAPI::EmptyDeployment>
...
CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ::v1::com::harman::mmpres::MediaSettingsStub,
    std::tuple<bool, ::v3::com::harman::mmpres::MMPresTypes::tScreen>,
    std::tuple<::v3::com::harman::mmpres::MMPresTypes::eMediaError>,
    std::tuple<CommonAPI::EmptyDeployment, ::v3::com::harman::mmpres::MMPresTypes_::tScreenDeployment_t>,
    std::tuple<CommonAPI::EmptyDeployment>
    
    > MediaSettingsDBusStubAdapterInternal::setDisplayWindowStubDispatcher(
    &MediaSettingsStub::setDisplayWindow, "i",
					std::make_tuple(static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<::v3::com::harman::mmpres::MMPresTypes_::tScreenDeployment_t*>(nullptr)),
                	std::make_tuple(static_cast<CommonAPI::EmptyDeployment*>(nullptr)));


void MediaSettingsDBusStubAdapterInternal::fireSubtitleStatusAttributeChanged(const ::v3::com::harman::mmpres::MMPresTypes::eSubtitleStatus& value) {
 ...
 * description: Indicates the audio channels for the current track
 */
void MediaSettingsDBusStubAdapterInternal::fireAudioChannelAttributeChanged(const ::v3::com::harman::mmpres::MMPresTypes::eAudioChannelStatus& value) {
    CommonAPI::DBus::DBusStubSignalHelper<CommonAPI::DBus::DBusSerializableArguments<
    ::v3::com::harman::mmpres::MMPresTypes::eAudioChannelStatus
    >>
        ::sendSignal(
