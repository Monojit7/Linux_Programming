...
public:
    ...
    void fireSubtitleStatusAttributeChanged(const ::v3::com::harman::mmpres::MMPresTypes::eSubtitleStatus& value);
    void fireIsFullScreenAttributeChanged(const bool& value);
    /**
     * description: Indicates the audio channels for the current track
     */
    void fireAudioChannelAttributeChanged(const ::v3::com::harman::mmpres::MMPresTypes::eAudioChannelStatus& value);
    /**
