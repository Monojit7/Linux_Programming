...
public:
     ...
     *   query depends on the underlying browsing backend
     */
    virtual void listThumbnails(const std::string &_path, const uint64_t &_offset, const uint64_t &_count, const std::string &_query, CommonAPI::CallStatus &_internalCallStatus, std::vector<std::string> &_thumbnails, ::v1::org::genivi::mediamanager::BrowserTypes::BrowserError &_e, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> listThumbnailsAsync(const std::string &_path, const uint64_t &_offset, const uint64_t &_count, const std::string &_query, ListThumbnailsAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
     ...
     *   track, default is 0.
     */
    virtual void getMetadataIndexForTrack(const std::string &_path, const uint32_t &_trackId, CommonAPI::CallStatus &_internalCallStatus, uint64_t &_index, ::v1::org::genivi::mediamanager::BrowserTypes::BrowserError &_e, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> getMetadataIndexForTrackAsync(const std::string &_path, const uint32_t &_trackId, GetMetadataIndexForTrackAsyncCallback _callback, const CommonAPI::CallInfo *_info);
