...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * param: query Search query to match children against. The format of the                
     *   query depends on the underlying browsing backend
     * Calls listThumbnails with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void listThumbnails(const std::string &_path, const uint64_t &_offset, const uint64_t &_count, const std::string &_query, CommonAPI::CallStatus &_internalCallStatus, std::vector<std::string> &_thumbnails, ::v1::org::genivi::mediamanager::BrowserTypes::BrowserError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls listThumbnails with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> listThumbnailsAsync(const std::string &_path, const uint64_t &_offset, const uint64_t &_count, const std::string &_query, ListThumbnailsAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     *   track, default is 0.
     * Calls getMetadataIndexForTrack with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void getMetadataIndexForTrack(const std::string &_path, const uint32_t &_trackId, CommonAPI::CallStatus &_internalCallStatus, uint64_t &_index, ::v1::org::genivi::mediamanager::BrowserTypes::BrowserError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls getMetadataIndexForTrack with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> getMetadataIndexForTrackAsync(const std::string &_path, const uint32_t &_trackId, GetMetadataIndexForTrackAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listThumbnails(const std::string &_path, const uint64_t &_offset, const uint64_t &_count, const std::string &_query, CommonAPI::CallStatus &_internalCallStatus, std::vector<std::string> &_thumbnails, ::v1::org::genivi::mediamanager::BrowserTypes::BrowserError &_e, const CommonAPI::CallInfo *_info) {
    delegate_->listThumbnails(_path, _offset, _count, _query, _internalCallStatus, _thumbnails, _e, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::listThumbnailsAsync(const std::string &_path, const uint64_t &_offset, const uint64_t &_count, const std::string &_query, ListThumbnailsAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->listThumbnailsAsync(_path, _offset, _count, _query, _callback, _info);
}
/**
 * description: Create a new empty container with path used as root          returns: Path
 *   identifier for the newly created container          errors: NO_CONNECTION if
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::getMetadataIndexForTrack(const std::string &_path, const uint32_t &_trackId, CommonAPI::CallStatus &_internalCallStatus, uint64_t &_index, ::v1::org::genivi::mediamanager::BrowserTypes::BrowserError &_e, const CommonAPI::CallInfo *_info) {
    delegate_->getMetadataIndexForTrack(_path, _trackId, _internalCallStatus, _index, _e, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::getMetadataIndexForTrackAsync(const std::string &_path, const uint32_t &_trackId, GetMetadataIndexForTrackAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->getMetadataIndexForTrackAsync(_path, _trackId, _callback, _info);
}
