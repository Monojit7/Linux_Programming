...
public:
     ...
     */
    /**
     * Returns the wrapper class that provides access to the broadcast onRemotePlayerChanged.
     */
    virtual OnRemotePlayerChangedEvent& getOnRemotePlayerChangedEvent() {
        return delegate_->getOnRemotePlayerChangedEvent();
    }
    /**
     ...
     */
    /**
     * Returns the wrapper class that provides access to the broadcast onBluetoothProfilesStatus.
     */
    virtual OnBluetoothProfilesStatusEvent& getOnBluetoothProfilesStatusEvent() {
        return delegate_->getOnBluetoothProfilesStatusEvent();
    }
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * Calls eject with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void eject(const uint32_t &_mediumId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::media::BaseType::tBaseError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls eject with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> ejectAsync(const uint32_t &_mediumId, EjectAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     *   error code.
     * Calls requestSwitchMode with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void requestSwitchMode(const uint32_t &_mediumId, const ::v1::com::harman::media::BaseType::tMediumType &_mediumType, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::media::BaseType::tBaseError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls requestSwitchMode with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> requestSwitchModeAsync(const uint32_t &_mediumId, const ::v1::com::harman::media::BaseType::tMediumType &_mediumType, RequestSwitchModeAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
 ...
 */
template <typename ... _AttributeExtensions>
void DeviceManagerProxy<_AttributeExtensions...>::eject(const uint32_t &_mediumId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::media::BaseType::tBaseError &_e, const CommonAPI::CallInfo *_info) {
    delegate_->eject(_mediumId, _internalCallStatus, _e, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> DeviceManagerProxy<_AttributeExtensions...>::ejectAsync(const uint32_t &_mediumId, EjectAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->ejectAsync(_mediumId, _callback, _info);
}
/**
 * description: get device items information.  			mediumId: device id which connectted to the
 *   target. 			itemsInfo: imtes information will be returned. 			e: error code.
 ...
 */
template <typename ... _AttributeExtensions>
void DeviceManagerProxy<_AttributeExtensions...>::requestSwitchMode(const uint32_t &_mediumId, const ::v1::com::harman::media::BaseType::tMediumType &_mediumType, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::media::BaseType::tBaseError &_e, const CommonAPI::CallInfo *_info) {
    if (!_mediumType.validate()) {
        _internalCallStatus = CommonAPI::CallStatus::INVALID_VALUE;
        return;
    }
    delegate_->requestSwitchMode(_mediumId, _mediumType, _internalCallStatus, _e, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> DeviceManagerProxy<_AttributeExtensions...>::requestSwitchModeAsync(const uint32_t &_mediumId, const ::v1::com::harman::media::BaseType::tMediumType &_mediumType, RequestSwitchModeAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    if (!_mediumType.validate()) {
        ::v1::com::harman::media::BaseType::tBaseError e = ::v1::com::harman::media::BaseType::tBaseError::S_OK;
        _callback(CommonAPI::CallStatus::INVALID_VALUE, e);
        std::promise<CommonAPI::CallStatus> promise;
    ...
    return delegate_->requestSwitchModeAsync(_mediumId, _mediumType, _callback, _info);
}
