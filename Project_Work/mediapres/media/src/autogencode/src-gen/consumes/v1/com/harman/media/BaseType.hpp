...
struct BaseType {
    ...
    struct tMediumType : CommonAPI::Enumeration<int32_t> {
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::MT_SAL):
                case static_cast<int32_t>(Literal::MT_CARLIFE):
                case static_cast<int32_t>(Literal::MT_ANDROID):
                return true;
            default:
                return false;
            }
     ...
     */
    struct tRemotePlayerCapability : CommonAPI::Struct<bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, std::string> {
    	...
    	tRemotePlayerCapability(const bool &_supportPlay, const bool &_supportPause, const bool &_supportNext, const bool &_sSupportPrevious, const bool &_supportFastForward, const bool &_supportFastRewind, const bool &_supportRepeatOff, const bool &_supportRepeatSingle, const bool &_supportRepeatAll, const bool &_supportShuffle, const bool &_supportUnShuffle, const bool &_supportBrowsing, const bool &_supportSetPlaySpeed, const std::string &_playerName)
    	{
    		...
    		std::get<12>(values_) = _supportSetPlaySpeed;
    		std::get<13>(values_) = _playerName;
    	}
    	/**
    ...
    struct tBaseError : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            ...
            E_FILES_SKIPPED = 8,
            E_SYNC_FAILED = 9,
            E_MAX_SYNC_FILE_LIMIT = 10,
            E_MAX_DATABASE_LIMIT = 11
        };
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::E_SYNC_FAILED):
                case static_cast<int32_t>(Literal::E_MAX_SYNC_FILE_LIMIT):
                case static_cast<int32_t>(Literal::E_MAX_DATABASE_LIMIT):
                return true;
            default:
                return false;
            }
    ...
    struct eBTProfilesStatus : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            BTPROFILES_HANDFREE = 1,
            BTPROFILES_PHONEBOOKACCESS = 2,
            BTPROFILES_REMOTECONTROL = 4,
            BTPROFILES_AUDIODISTRIBUTION = 8,
            BTPROFILES_HUMANDEVICE = 16,
            BTPROFILES_IAP2LINK = 32,
            BTPROFILES_NETWORKACCESS = 64,
            BTPROFILES_MESSAGEACCESS = 128,
            BTPROFILES_NETWORKCLIENT = 256
        };
        
        eBTProfilesStatus() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::BTPROFILES_HANDFREE)) {}
        eBTProfilesStatus(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::BTPROFILES_HANDFREE):
                case static_cast<int32_t>(Literal::BTPROFILES_PHONEBOOKACCESS):
                case static_cast<int32_t>(Literal::BTPROFILES_REMOTECONTROL):
                case static_cast<int32_t>(Literal::BTPROFILES_AUDIODISTRIBUTION):
                case static_cast<int32_t>(Literal::BTPROFILES_HUMANDEVICE):
                case static_cast<int32_t>(Literal::BTPROFILES_IAP2LINK):
                case static_cast<int32_t>(Literal::BTPROFILES_NETWORKACCESS):
                case static_cast<int32_t>(Literal::BTPROFILES_MESSAGEACCESS):
                case static_cast<int32_t>(Literal::BTPROFILES_NETWORKCLIENT):
                return true;
            default:
                return false;
            }
        ...
        inline bool operator==(const eBTProfilesStatus &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const eBTProfilesStatus &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const eBTProfilesStatus &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const eBTProfilesStatus &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const eBTProfilesStatus &_other) const { return (value_ < _other.value_); }
...
namespace std {
    ...
    //Hash for eBTProfilesStatus
    template<>
    struct hash<::v1::com::harman::media::BaseType::eBTProfilesStatus> {
        inline size_t operator()(const ::v1::com::harman::media::BaseType::eBTProfilesStatus& eBTProfilesStatus) const {
            return static_cast<int32_t>(eBTProfilesStatus);
        }
    };
}
