...
struct notifalert_types {
    struct CtaAlrtRight_D_Stat_struct : CommonAPI::Struct<uint8_t, uint8_t> {
    	
    	CtaAlrtRight_D_Stat_struct() {
    	}
    	CtaAlrtRight_D_Stat_struct(const uint8_t &_CtaAlrtRight_D_Stat, const uint8_t &_status)
    	{
    		std::get<0>(values_) = _CtaAlrtRight_D_Stat;
    		std::get<1>(values_) = _status;
    	}
    	inline const uint8_t &getCtaAlrtRight_D_Stat() const { return std::get<0>(values_); }
    	inline void setCtaAlrtRight_D_Stat(const uint8_t &_value) { std::get<0>(values_) = _value; }
    	...
    	inline bool operator==(const CtaAlrtRight_D_Stat_struct& _other) const {
                return (getCtaAlrtRight_D_Stat() == _other.getCtaAlrtRight_D_Stat() && getStatus() == _other.getStatus());
        }
    	inline bool operator!=(const CtaAlrtRight_D_Stat_struct &_other) const {
    		return !((*this) == _other);
    	}
    ...
    struct CtaAlrtLeft_D_Stat_struct : CommonAPI::Struct<uint8_t, uint8_t> {
    	
    	CtaAlrtLeft_D_Stat_struct() {
    	}
    	CtaAlrtLeft_D_Stat_struct(const uint8_t &_CtaAlrtLeft_D_Stat, const uint8_t &_status)
    	{
    		std::get<0>(values_) = _CtaAlrtLeft_D_Stat;
    		std::get<1>(values_) = _status;
    	}
    	inline const uint8_t &getCtaAlrtLeft_D_Stat() const { return std::get<0>(values_); }
    	inline void setCtaAlrtLeft_D_Stat(const uint8_t &_value) { std::get<0>(values_) = _value; }
    	inline const uint8_t &getStatus() const { return std::get<1>(values_); }
    	inline void setStatus(const uint8_t &_value) { std::get<1>(values_) = _value; }
    	inline bool operator==(const CtaAlrtLeft_D_Stat_struct& _other) const {
                return (getCtaAlrtLeft_D_Stat() == _other.getCtaAlrtLeft_D_Stat() && getStatus() == _other.getStatus());
        }
    	inline bool operator!=(const CtaAlrtLeft_D_Stat_struct &_other) const {
    		return !((*this) == _other);
    	}
