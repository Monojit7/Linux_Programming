...
struct audio_types {
    ...
    struct IPC_Infotainment_struct : CommonAPI::Struct<IPC_New_Attn_Event_enum, IPC_Attn_Info_Audio_enum, BeltminderAudioMute_enum, IPC_MyKeyVolLimit_St_enum, Chime_Source_enum, Power_Up_Chime_Modules_enum, uint8_t> {
    	
    	IPC_Infotainment_struct() {
    	}
    	IPC_Infotainment_struct(const IPC_New_Attn_Event_enum &_iPC_New_Attn_Event_enum, const IPC_Attn_Info_Audio_enum &_iPC_Attn_Info_Audio_enum, const BeltminderAudioMute_enum &_beltminderAudioMute_enum, const IPC_MyKeyVolLimit_St_enum &_iPC_MyKeyVolLimit_St_enum, const Chime_Source_enum &_chime_Source_enum, const Power_Up_Chime_Modules_enum &_power_Up_Chime_Modules_enum, const uint8_t &_status)
    	{
