...
struct camerainfo_types {
    ...
    struct VehCharacteristicSet2_HS3_sig_4_struct : CommonAPI::Struct<uint16_t, VehLong2_A_Actl_UB_enum> {
    	
    	VehCharacteristicSet2_HS3_sig_4_struct() {
    	}
    	VehCharacteristicSet2_HS3_sig_4_struct(const uint16_t &_VehLong2_A_Actl, const VehLong2_A_Actl_UB_enum &_vehLong2_A_Actl_UB_enum)
    	{
    		std::get<0>(values_) = _VehLong2_A_Actl;
    		std::get<1>(values_) = _vehLong2_A_Actl_UB_enum;
    	}
    	inline const uint16_t &getVehLong2_A_Actl() const { return std::get<0>(values_); }
    	inline void setVehLong2_A_Actl(const uint16_t &_value) { std::get<0>(values_) = _value; }
    	...
    	inline bool operator==(const VehCharacteristicSet2_HS3_sig_4_struct& _other) const {
                return (getVehLong2_A_Actl() == _other.getVehLong2_A_Actl() && getVehLong2_A_Actl_UB_enum() == _other.getVehLong2_A_Actl_UB_enum());
        }
    	inline bool operator!=(const VehCharacteristicSet2_HS3_sig_4_struct &_other) const {
    		return !((*this) == _other);
    	}
