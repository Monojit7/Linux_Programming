...
struct emergassist_types {
    ...
    struct DoNotDisturbOveride_St_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_On = 2,
            En_Off = 1,
            En_No_Data_Exists = 0
        ...
        DoNotDisturbOveride_St_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_On)) {}
        DoNotDisturbOveride_St_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
        ...
        inline bool operator==(const DoNotDisturbOveride_St_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const DoNotDisturbOveride_St_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const DoNotDisturbOveride_St_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const DoNotDisturbOveride_St_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const DoNotDisturbOveride_St_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct Mc_Send_Signals_3_struct : CommonAPI::Struct<DoNotDisturbOveride_St_enum, MyKey_e911Override_St_enum> {
    	
    	Mc_Send_Signals_3_struct() {
    	}
    	Mc_Send_Signals_3_struct(const DoNotDisturbOveride_St_enum &_doNotDisturbOveride_St_enum, const MyKey_e911Override_St_enum &_myKey_e911Override_St_enum)
    	{
    		std::get<0>(values_) = _doNotDisturbOveride_St_enum;
    		std::get<1>(values_) = _myKey_e911Override_St_enum;
    	}
    	inline const DoNotDisturbOveride_St_enum &getDoNotDisturbOveride_St_enum() const { return std::get<0>(values_); }
    	inline void setDoNotDisturbOveride_St_enum(const DoNotDisturbOveride_St_enum &_value) { std::get<0>(values_) = _value; }
    	inline const MyKey_e911Override_St_enum &getMyKey_e911Override_St_enum() const { return std::get<1>(values_); }
    	inline void setMyKey_e911Override_St_enum(const MyKey_e911Override_St_enum &_value) { std::get<1>(values_) = _value; }
    	inline bool operator==(const Mc_Send_Signals_3_struct& _other) const {
                return (getDoNotDisturbOveride_St_enum() == _other.getDoNotDisturbOveride_St_enum() && getMyKey_e911Override_St_enum() == _other.getMyKey_e911Override_St_enum());
        }
    	inline bool operator!=(const Mc_Send_Signals_3_struct &_other) const {
    		return !((*this) == _other);
    	}
    ...
    struct VehEmergencyData1_HS3_struct : CommonAPI::Struct<VedsDrvBag_D_Ltchd_enum, VedsDrvBelt_D_Ltchd_enum, VedsDrvCrtnBag_D_Ltchd_enum, VedsDrvSideBag_D_Ltchd_enum, VedsEvntRoll_D_Ltchd_enum, VedsEvntType_D_Ltchd_enum, uint8_t, VedsMultiEvnt_D_Ltchd_enum, VedsPasBag_D_Ltchd_enum, VedsPasBelt_D_Ltchd_enum, VedsPasCrtnBag_D_Ltchd_enum, VedsPasSideBag_D_Ltchd_enum, VedsDrvKneeBag_D_Ltchd_enum, uint8_t> {
    	...
    	VehEmergencyData1_HS3_struct(const VedsDrvBag_D_Ltchd_enum &_vedsDrvBag_D_Ltchd_enum, const VedsDrvBelt_D_Ltchd_enum &_vedsDrvBelt_D_Ltchd_enum, const VedsDrvCrtnBag_D_Ltchd_enum &_vedsDrvCrtnBag_D_Ltchd_enum, const VedsDrvSideBag_D_Ltchd_enum &_vedsDrvSideBag_D_Ltchd_enum, const VedsEvntRoll_D_Ltchd_enum &_vedsEvntRoll_D_Ltchd_enum, const VedsEvntType_D_Ltchd_enum &_vedsEvntType_D_Ltchd_enum, const uint8_t &_VedsMaxDeltaV_D_Ltchd, const VedsMultiEvnt_D_Ltchd_enum &_vedsMultiEvnt_D_Ltchd_enum, const VedsPasBag_D_Ltchd_enum &_vedsPasBag_D_Ltchd_enum, const VedsPasBelt_D_Ltchd_enum &_vedsPasBelt_D_Ltchd_enum, const VedsPasCrtnBag_D_Ltchd_enum &_vedsPasCrtnBag_D_Ltchd_enum, const VedsPasSideBag_D_Ltchd_enum &_vedsPasSideBag_D_Ltchd_enum, const VedsDrvKneeBag_D_Ltchd_enum &_vedsDrvKneeBag_D_Ltchd_enum, const uint8_t &_status)
    	{
    		...
    		std::get<6>(values_) = _VedsMaxDeltaV_D_Ltchd;
    	...
    	inline const uint8_t &getVedsMaxDeltaV_D_Ltchd() const { return std::get<6>(values_); }
    	inline void setVedsMaxDeltaV_D_Ltchd(const uint8_t &_value) { std::get<6>(values_) = _value; }
...
namespace std {
    ...
    //Hash for DoNotDisturbOveride_St_enum
    template<>
    struct hash<::v0::org::harman::ford::emergassist_types::DoNotDisturbOveride_St_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::emergassist_types::DoNotDisturbOveride_St_enum& doNotDisturbOveride_St_enum) const {
            return static_cast<int32_t>(doNotDisturbOveride_St_enum);
        }
    };
