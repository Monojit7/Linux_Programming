...
struct actvparkassist_types {
    ...
    struct TurnLghtSwtch_D_Stat_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Unused_Treat_As_Off = 3,
            En_Right = 2,
            En_Left = 1,
            En_Off = 0
        };
        
        TurnLghtSwtch_D_Stat_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Unused_Treat_As_Off)) {}
        TurnLghtSwtch_D_Stat_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::En_Unused_Treat_As_Off):
                case static_cast<int32_t>(Literal::En_Right):
                case static_cast<int32_t>(Literal::En_Left):
                case static_cast<int32_t>(Literal::En_Off):
                return true;
        ...
        inline bool operator==(const TurnLghtSwtch_D_Stat_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const TurnLghtSwtch_D_Stat_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const TurnLghtSwtch_D_Stat_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const TurnLghtSwtch_D_Stat_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const TurnLghtSwtch_D_Stat_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct TurnLghtSwtch_D_Stat_UB_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Fresh_data = 1,
            En_Unchanged_data = 0
        };
        
        TurnLghtSwtch_D_Stat_UB_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Fresh_data)) {}
        TurnLghtSwtch_D_Stat_UB_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
        ...
        inline bool operator==(const TurnLghtSwtch_D_Stat_UB_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const TurnLghtSwtch_D_Stat_UB_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const TurnLghtSwtch_D_Stat_UB_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const TurnLghtSwtch_D_Stat_UB_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const TurnLghtSwtch_D_Stat_UB_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct Body_Info_1_HS3_sig_1_struct : CommonAPI::Struct<TurnLghtSwtch_D_Stat_enum, TurnLghtSwtch_D_Stat_UB_enum> {
    	
    	Body_Info_1_HS3_sig_1_struct() {
    	}
    	Body_Info_1_HS3_sig_1_struct(const TurnLghtSwtch_D_Stat_enum &_turnLghtSwtch_D_Stat_enum, const TurnLghtSwtch_D_Stat_UB_enum &_turnLghtSwtch_D_Stat_UB_enum)
    	{
    		std::get<0>(values_) = _turnLghtSwtch_D_Stat_enum;
    		std::get<1>(values_) = _turnLghtSwtch_D_Stat_UB_enum;
    	}
    	inline const TurnLghtSwtch_D_Stat_enum &getTurnLghtSwtch_D_Stat_enum() const { return std::get<0>(values_); }
    	inline void setTurnLghtSwtch_D_Stat_enum(const TurnLghtSwtch_D_Stat_enum &_value) { std::get<0>(values_) = _value; }
    	inline const TurnLghtSwtch_D_Stat_UB_enum &getTurnLghtSwtch_D_Stat_UB_enum() const { return std::get<1>(values_); }
    	inline void setTurnLghtSwtch_D_Stat_UB_enum(const TurnLghtSwtch_D_Stat_UB_enum &_value) { std::get<1>(values_) = _value; }
    	inline bool operator==(const Body_Info_1_HS3_sig_1_struct& _other) const {
                return (getTurnLghtSwtch_D_Stat_enum() == _other.getTurnLghtSwtch_D_Stat_enum() && getTurnLghtSwtch_D_Stat_UB_enum() == _other.getTurnLghtSwtch_D_Stat_UB_enum());
        }
    	inline bool operator!=(const Body_Info_1_HS3_sig_1_struct &_other) const {
    		return !((*this) == _other);
    	}
...
namespace std {
    ...
    //Hash for TurnLghtSwtch_D_Stat_enum
    template<>
    struct hash<::v0::org::harman::ford::actvparkassist_types::TurnLghtSwtch_D_Stat_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::actvparkassist_types::TurnLghtSwtch_D_Stat_enum& turnLghtSwtch_D_Stat_enum) const {
            return static_cast<int32_t>(turnLghtSwtch_D_Stat_enum);
        }
    };
    //Hash for TurnLghtSwtch_D_Stat_UB_enum
    template<>
    struct hash<::v0::org::harman::ford::actvparkassist_types::TurnLghtSwtch_D_Stat_UB_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::actvparkassist_types::TurnLghtSwtch_D_Stat_UB_enum& turnLghtSwtch_D_Stat_UB_enum) const {
            return static_cast<int32_t>(turnLghtSwtch_D_Stat_UB_enum);
        }
    };
