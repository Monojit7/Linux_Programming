...
struct navi_types {
    ...
    struct OtaTrg_D_Rq_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_NotUsed_1 = 3,
            En_Ivsu = 2,
            En_Nav = 1,
        ...
        OtaTrg_D_Rq_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::En_NotUsed_1):
                case static_cast<int32_t>(Literal::En_Ivsu):
                case static_cast<int32_t>(Literal::En_Nav):
        ...
        inline bool operator==(const OtaTrg_D_Rq_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const OtaTrg_D_Rq_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const OtaTrg_D_Rq_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const OtaTrg_D_Rq_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const OtaTrg_D_Rq_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct TCU_Request_Signals_1_struct : CommonAPI::Struct<OtaTrg_D_Rq_enum> {
    	
    	TCU_Request_Signals_1_struct() {
    	}
    	TCU_Request_Signals_1_struct(const OtaTrg_D_Rq_enum &_otaTrg_D_Rq_enum)
    	{
    		std::get<0>(values_) = _otaTrg_D_Rq_enum;
    	}
    	inline const OtaTrg_D_Rq_enum &getOtaTrg_D_Rq_enum() const { return std::get<0>(values_); }
    	inline void setOtaTrg_D_Rq_enum(const OtaTrg_D_Rq_enum &_value) { std::get<0>(values_) = _value; }
    	inline bool operator==(const TCU_Request_Signals_1_struct& _other) const {
                return (getOtaTrg_D_Rq_enum() == _other.getOtaTrg_D_Rq_enum());
        }
    	inline bool operator!=(const TCU_Request_Signals_1_struct &_other) const {
    		return !((*this) == _other);
    	}
...
namespace std {
    ...
    //Hash for OtaTrg_D_Rq_enum
    template<>
    struct hash<::v0::org::harman::ford::navi_types::OtaTrg_D_Rq_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::navi_types::OtaTrg_D_Rq_enum& otaTrg_D_Rq_enum) const {
            return static_cast<int32_t>(otaTrg_D_Rq_enum);
        }
    };
}
