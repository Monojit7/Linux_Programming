...
struct enginedata_types {
    ...
    struct ActvDrvMde_D2_Stat_enum : CommonAPI::Enumeration<int32_t> {
        ...
        ActvDrvMde_D2_Stat_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Faulty)) {}
        ActvDrvMde_D2_Stat_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::En_Faulty):
                case static_cast<int32_t>(Literal::En_SelDrvMde31):
                case static_cast<int32_t>(Literal::En_SelDrvMde30):
                case static_cast<int32_t>(Literal::En_SelDrvMde29):
                case static_cast<int32_t>(Literal::En_SelDrvMde28):
                case static_cast<int32_t>(Literal::En_SelDrvMde27):
                case static_cast<int32_t>(Literal::En_SelDrvMde26):
                case static_cast<int32_t>(Literal::En_SelDrvMde25):
                case static_cast<int32_t>(Literal::En_SelDrvMde24):
                case static_cast<int32_t>(Literal::En_SelDrvMde23):
                case static_cast<int32_t>(Literal::En_SelDrvMde22):
                case static_cast<int32_t>(Literal::En_SelDrvMde21):
                case static_cast<int32_t>(Literal::En_SelDrvMde20):
                case static_cast<int32_t>(Literal::En_SelDrvMde19):
                case static_cast<int32_t>(Literal::En_SelDrvMde18):
                case static_cast<int32_t>(Literal::En_SelDrvMde17):
                case static_cast<int32_t>(Literal::En_SelDrvMde16):
                case static_cast<int32_t>(Literal::En_SelDrvMde15):
                case static_cast<int32_t>(Literal::En_SelDrvMde14):
                case static_cast<int32_t>(Literal::En_SelDrvMde13):
                case static_cast<int32_t>(Literal::En_SelDrvMde12):
                case static_cast<int32_t>(Literal::En_SelDrvMde11):
                case static_cast<int32_t>(Literal::En_SelDrvMde10):
                case static_cast<int32_t>(Literal::En_SelDrvMde09):
                case static_cast<int32_t>(Literal::En_SelDrvMde08):
                case static_cast<int32_t>(Literal::En_SelDrvMde07):
                case static_cast<int32_t>(Literal::En_SelDrvMde06):
                case static_cast<int32_t>(Literal::En_SelDrvMde05):
                case static_cast<int32_t>(Literal::En_SelDrvMde04):
                case static_cast<int32_t>(Literal::En_SelDrvMde03):
                case static_cast<int32_t>(Literal::En_SelDrvMde02):
                case static_cast<int32_t>(Literal::En_SelDrvMde01):
                return true;
            default:
                return false;
            }
        ...
        inline bool operator==(const ActvDrvMde_D2_Stat_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const ActvDrvMde_D2_Stat_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const ActvDrvMde_D2_Stat_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const ActvDrvMde_D2_Stat_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const ActvDrvMde_D2_Stat_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct AwdStat_D_RqDsply_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_NotUsed9 = 31,
            En_NotUsed8 = 30,
            En_NotUsed7 = 29,
            En_Lkr_Mode_Unavail_TMS = 25,
            En_4x4_Mode_Unavail__TMS = 24,
            En_Out_of_4Low_Crawl = 23,
            En_AWD_PTU_Oil_Changed = 22,
            En_Change_AWD_PTU_Oil = 21,
            En_Neutral_Tow_Disabled = 20,
            En_Neutral_Tow_Enabled = 19,
            En_AWD_OFF = 18,
            En__4x4_Off_Road_Speed = 17,
            En__4x4_Extreme_Off_Road_Mode = 16,
            En__4x4_Exiting_Off_Road = 15,
            En__4x4_Off_Road_Mode = 14,
            En__4x4_Locked_Temporarily = 10,
            En_Shift_In_Progress = 9,
            En_Blocked_Shift_Assist = 13,
            En__4x4_Auto_Restored = 12,
            En__4x4_Disabled_Temporarily = 11,
            En_Out_of_4Low__Neutral = 7,
            En_Out_of_4Low__Brake = 6,
            En_Out_of_4Low__Speed = 5,
            En_Into_4Low__Clutch = 4,
            En_Into_4Low__Neutral = 3,
            En_Into_4Low__Brake = 2,
            En_Into_4Low__Speed = 1,
            En_Normal__No_Message = 0,
            En_Out_of_4Low__Clutch = 8,
            En_To_Engage_4x4_Release_Aped = 28,
            En_To_Engage_4x4_Slow_To_3MPH = 27,
            En_Shift_To_Neutral = 26
        };
        
        AwdStat_D_RqDsply_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_NotUsed9)) {}
        AwdStat_D_RqDsply_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::En_NotUsed9):
                case static_cast<int32_t>(Literal::En_NotUsed8):
                case static_cast<int32_t>(Literal::En_NotUsed7):
                case static_cast<int32_t>(Literal::En_Lkr_Mode_Unavail_TMS):
                case static_cast<int32_t>(Literal::En_4x4_Mode_Unavail__TMS):
                case static_cast<int32_t>(Literal::En_Out_of_4Low_Crawl):
                case static_cast<int32_t>(Literal::En_AWD_PTU_Oil_Changed):
                case static_cast<int32_t>(Literal::En_Change_AWD_PTU_Oil):
                case static_cast<int32_t>(Literal::En_Neutral_Tow_Disabled):
                case static_cast<int32_t>(Literal::En_Neutral_Tow_Enabled):
                case static_cast<int32_t>(Literal::En_AWD_OFF):
                case static_cast<int32_t>(Literal::En__4x4_Off_Road_Speed):
                case static_cast<int32_t>(Literal::En__4x4_Extreme_Off_Road_Mode):
                case static_cast<int32_t>(Literal::En__4x4_Exiting_Off_Road):
                case static_cast<int32_t>(Literal::En__4x4_Off_Road_Mode):
                case static_cast<int32_t>(Literal::En__4x4_Locked_Temporarily):
                case static_cast<int32_t>(Literal::En_Shift_In_Progress):
                case static_cast<int32_t>(Literal::En_Blocked_Shift_Assist):
                case static_cast<int32_t>(Literal::En__4x4_Auto_Restored):
                case static_cast<int32_t>(Literal::En__4x4_Disabled_Temporarily):
                case static_cast<int32_t>(Literal::En_Out_of_4Low__Neutral):
                case static_cast<int32_t>(Literal::En_Out_of_4Low__Brake):
                case static_cast<int32_t>(Literal::En_Out_of_4Low__Speed):
                case static_cast<int32_t>(Literal::En_Into_4Low__Clutch):
                case static_cast<int32_t>(Literal::En_Into_4Low__Neutral):
                case static_cast<int32_t>(Literal::En_Into_4Low__Brake):
                case static_cast<int32_t>(Literal::En_Into_4Low__Speed):
                case static_cast<int32_t>(Literal::En_Normal__No_Message):
                case static_cast<int32_t>(Literal::En_Out_of_4Low__Clutch):
                case static_cast<int32_t>(Literal::En_To_Engage_4x4_Release_Aped):
                case static_cast<int32_t>(Literal::En_To_Engage_4x4_Slow_To_3MPH):
                case static_cast<int32_t>(Literal::En_Shift_To_Neutral):
                return true;
            default:
                return false;
            }
        ...
        inline bool operator==(const AwdStat_D_RqDsply_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const AwdStat_D_RqDsply_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const AwdStat_D_RqDsply_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const AwdStat_D_RqDsply_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const AwdStat_D_RqDsply_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct FactoryReset_St_enum : CommonAPI::Enumeration<int32_t> {
        ...
        FactoryReset_St_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_FactoryDefaultsRestored)) {}
    ...
    struct TirePReset_D_Stat_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Not_Used = 3,
            En_Nack = 2,
            En_Ack = 1,
        ...
        TirePReset_D_Stat_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Not_Used)) {}
        TirePReset_D_Stat_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::En_Not_Used):
                case static_cast<int32_t>(Literal::En_Nack):
                case static_cast<int32_t>(Literal::En_Ack):
                case static_cast<int32_t>(Literal::En_Null):
                return true;
            default:
                return false;
        ...
        inline bool operator==(const TirePReset_D_Stat_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const TirePReset_D_Stat_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const TirePReset_D_Stat_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const TirePReset_D_Stat_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const TirePReset_D_Stat_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct Tire_Pressure_Status_struct : CommonAPI::Struct<TirePReset_D_Stat_enum, Tire_Press_Telltale_enum, Tire_Press_System_Stat_enum, Tire_Press_RF_Stat_enum, Tire_Press_LF_Stat_enum, Tire_Press_LR_OLR_Stat_enum, Tire_Press_RR_ORR_Stat_enum, Tire_Press_ILR_Stat_enum, Tire_Press_IRR_Stat_enum, uint8_t, uint8_t> {
    	
    	Tire_Pressure_Status_struct() {
    	}
    	Tire_Pressure_Status_struct(const TirePReset_D_Stat_enum &_tirePReset_D_Stat_enum, const Tire_Press_Telltale_enum &_tire_Press_Telltale_enum, const Tire_Press_System_Stat_enum &_tire_Press_System_Stat_enum, const Tire_Press_RF_Stat_enum &_tire_Press_RF_Stat_enum, const Tire_Press_LF_Stat_enum &_tire_Press_LF_Stat_enum, const Tire_Press_LR_OLR_Stat_enum &_tire_Press_LR_OLR_Stat_enum, const Tire_Press_RR_ORR_Stat_enum &_tire_Press_RR_ORR_Stat_enum, const Tire_Press_ILR_Stat_enum &_tire_Press_ILR_Stat_enum, const Tire_Press_IRR_Stat_enum &_tire_Press_IRR_Stat_enum, const uint8_t &_Tire_Press_Placrd_Frnt, const uint8_t &_Tire_Press_Placrd_Rear)
    	{
    		std::get<0>(values_) = _tirePReset_D_Stat_enum;
    		std::get<1>(values_) = _tire_Press_Telltale_enum;
    		std::get<2>(values_) = _tire_Press_System_Stat_enum;
    		std::get<3>(values_) = _tire_Press_RF_Stat_enum;
    		std::get<4>(values_) = _tire_Press_LF_Stat_enum;
    		std::get<5>(values_) = _tire_Press_LR_OLR_Stat_enum;
    		std::get<6>(values_) = _tire_Press_RR_ORR_Stat_enum;
    		std::get<7>(values_) = _tire_Press_ILR_Stat_enum;
    		std::get<8>(values_) = _tire_Press_IRR_Stat_enum;
    		std::get<9>(values_) = _Tire_Press_Placrd_Frnt;
    		std::get<10>(values_) = _Tire_Press_Placrd_Rear;
    	}
    	inline const TirePReset_D_Stat_enum &getTirePReset_D_Stat_enum() const { return std::get<0>(values_); }
    	inline void setTirePReset_D_Stat_enum(const TirePReset_D_Stat_enum &_value) { std::get<0>(values_) = _value; }
    	inline const Tire_Press_Telltale_enum &getTire_Press_Telltale_enum() const { return std::get<1>(values_); }
    	inline void setTire_Press_Telltale_enum(const Tire_Press_Telltale_enum &_value) { std::get<1>(values_) = _value; }
    	inline const Tire_Press_System_Stat_enum &getTire_Press_System_Stat_enum() const { return std::get<2>(values_); }
    	inline void setTire_Press_System_Stat_enum(const Tire_Press_System_Stat_enum &_value) { std::get<2>(values_) = _value; }
    	inline const Tire_Press_RF_Stat_enum &getTire_Press_RF_Stat_enum() const { return std::get<3>(values_); }
    	inline void setTire_Press_RF_Stat_enum(const Tire_Press_RF_Stat_enum &_value) { std::get<3>(values_) = _value; }
    	inline const Tire_Press_LF_Stat_enum &getTire_Press_LF_Stat_enum() const { return std::get<4>(values_); }
    	inline void setTire_Press_LF_Stat_enum(const Tire_Press_LF_Stat_enum &_value) { std::get<4>(values_) = _value; }
    	inline const Tire_Press_LR_OLR_Stat_enum &getTire_Press_LR_OLR_Stat_enum() const { return std::get<5>(values_); }
    	inline void setTire_Press_LR_OLR_Stat_enum(const Tire_Press_LR_OLR_Stat_enum &_value) { std::get<5>(values_) = _value; }
    	inline const Tire_Press_RR_ORR_Stat_enum &getTire_Press_RR_ORR_Stat_enum() const { return std::get<6>(values_); }
    	inline void setTire_Press_RR_ORR_Stat_enum(const Tire_Press_RR_ORR_Stat_enum &_value) { std::get<6>(values_) = _value; }
    	inline const Tire_Press_ILR_Stat_enum &getTire_Press_ILR_Stat_enum() const { return std::get<7>(values_); }
    	inline void setTire_Press_ILR_Stat_enum(const Tire_Press_ILR_Stat_enum &_value) { std::get<7>(values_) = _value; }
    	inline const Tire_Press_IRR_Stat_enum &getTire_Press_IRR_Stat_enum() const { return std::get<8>(values_); }
    	inline void setTire_Press_IRR_Stat_enum(const Tire_Press_IRR_Stat_enum &_value) { std::get<8>(values_) = _value; }
    	inline const uint8_t &getTire_Press_Placrd_Frnt() const { return std::get<9>(values_); }
    	inline void setTire_Press_Placrd_Frnt(const uint8_t &_value) { std::get<9>(values_) = _value; }
    	inline const uint8_t &getTire_Press_Placrd_Rear() const { return std::get<10>(values_); }
    	inline void setTire_Press_Placrd_Rear(const uint8_t &_value) { std::get<10>(values_) = _value; }
    	inline bool operator==(const Tire_Pressure_Status_struct& _other) const {
                return (getTirePReset_D_Stat_enum() == _other.getTirePReset_D_Stat_enum() && getTire_Press_Telltale_enum() == _other.getTire_Press_Telltale_enum() && getTire_Press_System_Stat_enum() == _other.getTire_Press_System_Stat_enum() && getTire_Press_RF_Stat_enum() == _other.getTire_Press_RF_Stat_enum() && getTire_Press_LF_Stat_enum() == _other.getTire_Press_LF_Stat_enum() && getTire_Press_LR_OLR_Stat_enum() == _other.getTire_Press_LR_OLR_Stat_enum() && getTire_Press_RR_ORR_Stat_enum() == _other.getTire_Press_RR_ORR_Stat_enum() && getTire_Press_ILR_Stat_enum() == _other.getTire_Press_ILR_Stat_enum() && getTire_Press_IRR_Stat_enum() == _other.getTire_Press_IRR_Stat_enum() && getTire_Press_Placrd_Frnt() == _other.getTire_Press_Placrd_Frnt() && getTire_Press_Placrd_Rear() == _other.getTire_Press_Placrd_Rear());
        }
    	inline bool operator!=(const Tire_Pressure_Status_struct &_other) const {
    		return !((*this) == _other);
    	}
    ...
    struct StePinComp_An_Est_UB_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Fresh_data = 1,
            En_Unchanged_data = 0
        };
        
        StePinComp_An_Est_UB_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Fresh_data)) {}
        StePinComp_An_Est_UB_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
        ...
        inline bool operator==(const StePinComp_An_Est_UB_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const StePinComp_An_Est_UB_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const StePinComp_An_Est_UB_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const StePinComp_An_Est_UB_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const StePinComp_An_Est_UB_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct GWM_Send_Signals_12_HS3_sig_0_struct : CommonAPI::Struct<uint16_t, StePinComp_An_Est_UB_enum> {
    	
    	GWM_Send_Signals_12_HS3_sig_0_struct() {
    	}
    	GWM_Send_Signals_12_HS3_sig_0_struct(const uint16_t &_StePinComp_An_Est, const StePinComp_An_Est_UB_enum &_stePinComp_An_Est_UB_enum)
    	{
    		std::get<0>(values_) = _StePinComp_An_Est;
    		std::get<1>(values_) = _stePinComp_An_Est_UB_enum;
    	}
    	inline const uint16_t &getStePinComp_An_Est() const { return std::get<0>(values_); }
    	inline void setStePinComp_An_Est(const uint16_t &_value) { std::get<0>(values_) = _value; }
    	inline const StePinComp_An_Est_UB_enum &getStePinComp_An_Est_UB_enum() const { return std::get<1>(values_); }
    	inline void setStePinComp_An_Est_UB_enum(const StePinComp_An_Est_UB_enum &_value) { std::get<1>(values_) = _value; }
    	inline bool operator==(const GWM_Send_Signals_12_HS3_sig_0_struct& _other) const {
                return (getStePinComp_An_Est() == _other.getStePinComp_An_Est() && getStePinComp_An_Est_UB_enum() == _other.getStePinComp_An_Est_UB_enum());
        }
    	inline bool operator!=(const GWM_Send_Signals_12_HS3_sig_0_struct &_other) const {
    		return !((*this) == _other);
    	}
...
namespace std {
    //Hash for ActvDrvMde_D2_Stat_enum
    template<>
    struct hash<::v0::org::harman::ford::enginedata_types::ActvDrvMde_D2_Stat_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::enginedata_types::ActvDrvMde_D2_Stat_enum& actvDrvMde_D2_Stat_enum) const {
            return static_cast<int32_t>(actvDrvMde_D2_Stat_enum);
        }
    };
    ...
    //Hash for AwdStat_D_RqDsply_enum
    template<>
    struct hash<::v0::org::harman::ford::enginedata_types::AwdStat_D_RqDsply_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::enginedata_types::AwdStat_D_RqDsply_enum& awdStat_D_RqDsply_enum) const {
            return static_cast<int32_t>(awdStat_D_RqDsply_enum);
        }
    };
    ...
    //Hash for TirePReset_D_Stat_enum
    template<>
    struct hash<::v0::org::harman::ford::enginedata_types::TirePReset_D_Stat_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::enginedata_types::TirePReset_D_Stat_enum& tirePReset_D_Stat_enum) const {
            return static_cast<int32_t>(tirePReset_D_Stat_enum);
        }
    };
    ...
    //Hash for StePinComp_An_Est_UB_enum
    template<>
    struct hash<::v0::org::harman::ford::enginedata_types::StePinComp_An_Est_UB_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::enginedata_types::StePinComp_An_Est_UB_enum& stePinComp_An_Est_UB_enum) const {
            return static_cast<int32_t>(stePinComp_An_Est_UB_enum);
        }
    };
}
