...
*/
#ifndef V3_COM_HARMAN_MMPRES_Media_Browser_STUB_HPP_
#define V3_COM_HARMAN_MMPRES_Media_Browser_STUB_HPP_
 ...
 * to a stub for the service MediaBrowser. Also provides means to send broadcasts
 * and attribute-changed-notifications of observable attributes as defined by this service.
 * An application developer should not need to bother with this class.
 */
class MediaBrowserStubAdapter
    : public virtual CommonAPI::StubAdapter, 
      public virtual MediaBrowser {
 public:
    ///Notifies all remote listeners about a change of value of the attribute searchCandidates.
    virtual void fireSearchCandidatesAttributeChanged(const std::vector<std::string>& searchCandidates) = 0;
    ///Notifies all remote listeners about a change of value of the attribute itemIndexTobeHighlighted.
    virtual void fireItemIndexTobeHighlightedAttributeChanged(const ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap& itemIndexTobeHighlighted) = 0;

    /**
     * Sends a selective broadcast event for sessionQueryUpdate. Should not be called directly.
     * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
     */
    virtual void fireSessionQueryUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> _client, const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_numResults) = 0;
    virtual void sendSessionQueryUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_numResults, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
     ...
     * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
     */
    virtual void fireSessionQueryWindowUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> _client, const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::eQueryStatus &_status, const uint64_t &_startIndex, const uint64_t &_numItems, const ::v3::com::harman::mmpres::MMPresTypes::MetadataItemList &_itemList, const bool &_windowContainsCurrentlyPlayingTrack, const uint64_t &_itemIndexTobeHighlighted) = 0;
    virtual void sendSessionQueryWindowUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::eQueryStatus &_status, const uint64_t &_startIndex, const uint64_t &_numItems, const ::v3::com::harman::mmpres::MMPresTypes::MetadataItemList &_itemList, const bool &_windowContainsCurrentlyPlayingTrack, const uint64_t &_itemIndexTobeHighlighted, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    ...
    /**
     * Sends a selective broadcast event for thumbnailListUpdate. Should not be called directly.
     * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
     */
    virtual void fireThumbnailListUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> _client, const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, const std::vector<std::string> &_thumbnaiList) = 0;
    virtual void sendThumbnailListUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, const std::vector<std::string> &_thumbnaiList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    virtual void subscribeForthumbnailListUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> clientId, bool& success) = 0;
    virtual void unsubscribeFromthumbnailListUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    virtual std::shared_ptr<CommonAPI::ClientIdList> const getSubscribersForThumbnailListUpdateSelective() = 0;
    /**
     * Sends a selective broadcast event for sessionQueryAlphaJumpUpdate. Should not be called directly.
     * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
     */
    virtual void fireSessionQueryAlphaJumpUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> _client, const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::arAlphaIndex &_ajList) = 0;
    virtual void sendSessionQueryAlphaJumpUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::arAlphaIndex &_ajList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    virtual void subscribeForsessionQueryAlphaJumpUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> clientId, bool& success) = 0;
    virtual void unsubscribeFromsessionQueryAlphaJumpUpdateSelective(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    virtual std::shared_ptr<CommonAPI::ClientIdList> const getSubscribersForSessionQueryAlphaJumpUpdateSelective() = 0;
...
protected:
    ...
    std::shared_ptr<CommonAPI::ClientIdList> subscribersForThumbnailListUpdateSelective_;
    std::shared_ptr<CommonAPI::ClientIdList> subscribersForSessionQueryAlphaJumpUpdateSelective_;
};

/**
 * Defines the necessary callbacks to handle remote set events related to the attributes
 * defined in the IDL description for MediaBrowser.
 ...
 */
class MediaBrowserStubRemoteEvent
{
public:
    virtual ~MediaBrowserStubRemoteEvent() { }

};

/**
 * Defines the interface that must be implemented by any class that should provide
 * the service MediaBrowser to remote clients.
 * This class and the one above are the ones an application developer needs to have
 * a look at if he wants to implement a service.
 */
class MediaBrowserStub
    : public virtual CommonAPI::Stub<MediaBrowserStubAdapter, MediaBrowserStubRemoteEvent>
{
public:
    typedef std::function<void (uint32_t _sessionID, ::v3::com::harman::mmpres::MMPresTypes::eCallResult _result)>openSessionReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result)>closeSessionReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result)>cancelSessionReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numResults, uint32_t _sessionQueryID, std::string _breadcrumbpath, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType _lresultType)>setSessionQueryReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result)>setSessionQueryWindowReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numResults, uint32_t _sessionQueryID, ::v3::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel _browselevel, std::string _breadcrumbpath, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType _resultType)>gotoPreviousSessionQueryReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numResults, std::string _breadcrumbpath)>jumpToSessionQueryReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result)>playSessionReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result)>gotoTrackReply_t;
    typedef std::function<void (::v3::com::harman::mmpres::MMPresTypes::eCallResult _result, uint64_t _numItems, uint32_t _sessionQueryID)>gotoNowplayingLevelReply_t;
    typedef std::function<void (float _timeout)>getElevatorBarHelperLetterTimeoutReply_t;

    virtual ~MediaBrowserStub() {}
    virtual const CommonAPI::Version& getInterfaceVersion(std::shared_ptr<CommonAPI::ClientId> clientId) = 0;

    /// Provides getter access to the attribute searchCandidates
    virtual const std::vector<std::string> &getSearchCandidatesAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /// Provides getter access to the attribute itemIndexTobeHighlighted
    virtual const ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap &getItemIndexTobeHighlightedAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    ...
    virtual void openSession(const std::shared_ptr<CommonAPI::ClientId> _client, openSessionReply_t _reply) = 0;
    /**
    ...
    virtual void closeSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, closeSessionReply_t _reply) = 0;
    /**
     ...
     */
    /// This is the method that will be called on remote calls on the method cancelSession.
    virtual void cancelSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, cancelSessionReply_t _reply) = 0;
    /**
    ...
    virtual void setSessionQuery(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint8_t _slotId, ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap _filterIDs, ::v3::com::harman::mmpres::MMPresTypes::FilterMap _filters, ::v3::com::harman::mmpres::MMPresTypes::eMetadataType _resultType, uint32_t _metadataAttributes, uint32_t _metadataCountTypes, ::v3::com::harman::mmpres::MMPresTypes::eSessionQueryTypes _type, bool _resetPrevious, bool _AutoUpdateEnabled, uint32_t _ContentMask, setSessionQueryReply_t _reply) = 0;
    /**
    ...
    virtual void setSessionQueryWindow(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint32_t _sessionQueryID, uint64_t _startIndex, uint64_t _numItems, setSessionQueryWindowReply_t _reply) = 0;
    /**
     * description: Reselects the previous selected session query criteria. The previously shared
     *   sessionQueryID  will be returned.
     */
    /// This is the method that will be called on remote calls on the method gotoPreviousSessionQuery.
    virtual void gotoPreviousSessionQuery(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, gotoPreviousSessionQueryReply_t _reply) = 0;
    /**
     * description: HMI Can use this to do a direct jump to any previous query ids
     */
    /// This is the method that will be called on remote calls on the method jumpToSessionQuery.
    virtual void jumpToSessionQuery(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint32_t _sessionQueryID, jumpToSessionQueryReply_t _reply) = 0;
    /**
     ...
     */
    /// This is the method that will be called on remote calls on the method playSession.
    virtual void playSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap _filterIDs, playSessionReply_t _reply) = 0;
    /**
     ...
     */
    /// This is the method that will be called on remote calls on the method gotoTrack.
    virtual void gotoTrack(const std::shared_ptr<CommonAPI::ClientId> _client, uint64_t _trackPosition, gotoTrackReply_t _reply) = 0;
    /**
     ...
     */
    /// This is the method that will be called on remote calls on the method gotoNowplayingLevel.
    virtual void gotoNowplayingLevel(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint8_t _slotId, gotoNowplayingLevelReply_t _reply) = 0;
    /**
     ...
     *   config file.
     */
    /// This is the method that will be called on remote calls on the method getElevatorBarHelperLetterTimeout.
    virtual void getElevatorBarHelperLetterTimeout(const std::shared_ptr<CommonAPI::ClientId> _client, getElevatorBarHelperLetterTimeoutReply_t _reply) = 0;
    /**
     ...
     */
    virtual void fireSessionQueryUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_numResults, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
     ...
     */
    /**
     * Sends a selective broadcast event for thumbnailListUpdate to the given ClientIds.
     * The ClientIds must all be out of the set of subscribed clients.
     * If no ClientIds are given, the selective broadcast is sent to all subscribed clients.
     */
    virtual void fireThumbnailListUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, const std::vector<std::string> &_thumbnaiList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    /// retreives the list of all subscribed clients for thumbnailListUpdate
    virtual std::shared_ptr<CommonAPI::ClientIdList> const getSubscribersForThumbnailListUpdateSelective() = 0;
    /// Hook method for reacting on new subscriptions or removed subscriptions respectively for selective broadcasts.
    virtual void onThumbnailListUpdateSelectiveSubscriptionChanged(const std::shared_ptr<CommonAPI::ClientId> _client, const CommonAPI::SelectiveBroadcastSubscriptionEvent _event) = 0;
    /// Hook method for reacting accepting or denying new subscriptions 
    virtual bool onThumbnailListUpdateSelectiveSubscriptionRequested(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /**
     * description: Publishes the query status to all clients. The client can get the data once the
     *   query is "finished" 	 	     returns  sessionID: 	   The Session ID alloted.   
     ...
     */
    /**
     * Sends a selective broadcast event for sessionQueryAlphaJumpUpdate to the given ClientIds.
     * The ClientIds must all be out of the set of subscribed clients.
     * If no ClientIds are given, the selective broadcast is sent to all subscribed clients.
     */
    virtual void fireSessionQueryAlphaJumpUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::arAlphaIndex &_ajList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr) = 0;
    /// retreives the list of all subscribed clients for sessionQueryAlphaJumpUpdate
    virtual std::shared_ptr<CommonAPI::ClientIdList> const getSubscribersForSessionQueryAlphaJumpUpdateSelective() = 0;
    /// Hook method for reacting on new subscriptions or removed subscriptions respectively for selective broadcasts.
    virtual void onSessionQueryAlphaJumpUpdateSelectiveSubscriptionChanged(const std::shared_ptr<CommonAPI::ClientId> _client, const CommonAPI::SelectiveBroadcastSubscriptionEvent _event) = 0;
    /// Hook method for reacting accepting or denying new subscriptions 
    virtual bool onSessionQueryAlphaJumpUpdateSelectiveSubscriptionRequested(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;

    using CommonAPI::Stub<MediaBrowserStubAdapter, MediaBrowserStubRemoteEvent>::initStubAdapter;
    typedef CommonAPI::Stub<MediaBrowserStubAdapter, MediaBrowserStubRemoteEvent>::StubAdapterType StubAdapterType;
    typedef CommonAPI::Stub<MediaBrowserStubAdapter, MediaBrowserStubRemoteEvent>::RemoteEventHandlerType RemoteEventHandlerType;
    typedef MediaBrowserStubRemoteEvent RemoteEventType;
    typedef MediaBrowser StubInterface;
};
...
#endif // V3_COM_HARMAN_MMPRES_Media_Browser_STUB_HPP_
