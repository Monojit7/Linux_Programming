...
*/
#ifndef V3_COM_HARMAN_MMPRES_Media_Browser_STUB_DEFAULT_HPP_
#define V3_COM_HARMAN_MMPRES_Media_Browser_STUB_DEFAULT_HPP_
...
/**
 * Provides a default implementation for MediaBrowserStubRemoteEvent and
 * MediaBrowserStub. Method callbacks have an empty implementation,
 ...
 * behaviour.
 */
class MediaBrowserStubDefault
    : public virtual MediaBrowserStub {
public:
    MediaBrowserStubDefault();

    MediaBrowserStubRemoteEvent* initStubAdapter(const std::shared_ptr<MediaBrowserStubAdapter> &_adapter);

    const CommonAPI::Version& getInterfaceVersion(std::shared_ptr<CommonAPI::ClientId> _client);

    virtual const std::vector<std::string>& getSearchCandidatesAttribute();
    virtual const std::vector<std::string>& getSearchCandidatesAttribute(const std::shared_ptr<CommonAPI::ClientId> _client);
    virtual void setSearchCandidatesAttribute(std::vector<std::string> _value);
    virtual const ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap& getItemIndexTobeHighlightedAttribute();
    virtual const ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap& getItemIndexTobeHighlightedAttribute(const std::shared_ptr<CommonAPI::ClientId> _client);
    virtual void setItemIndexTobeHighlightedAttribute(::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap _value);
     ...
     */
    virtual void openSession(const std::shared_ptr<CommonAPI::ClientId> _client, openSessionReply_t _reply);
    /**
     ...
     */
    virtual void closeSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, closeSessionReply_t _reply);
    /**
     ...
     */
    virtual void cancelSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, cancelSessionReply_t _reply);
    /**
     ...
     */
    virtual void setSessionQueryWindow(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint32_t _sessionQueryID, uint64_t _startIndex, uint64_t _numItems, setSessionQueryWindowReply_t _reply);
    /**
     * description: Reselects the previous selected session query criteria. The previously shared
     *   sessionQueryID  will be returned.
     */
    virtual void gotoPreviousSessionQuery(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, gotoPreviousSessionQueryReply_t _reply);
    /**
     * description: HMI Can use this to do a direct jump to any previous query ids
     */
    virtual void jumpToSessionQuery(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint32_t _sessionQueryID, jumpToSessionQueryReply_t _reply);
    /**
     ...
     */
    virtual void playSession(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, ::v3::com::harman::mmpres::MMPresTypes::FilterIDMap _filterIDs, playSessionReply_t _reply);
    /**
     ...
     */
    virtual void gotoTrack(const std::shared_ptr<CommonAPI::ClientId> _client, uint64_t _trackPosition, gotoTrackReply_t _reply);
    /**
     ...
     */
    virtual void gotoNowplayingLevel(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _sessionID, uint8_t _slotId, gotoNowplayingLevelReply_t _reply);
    /**
     ...
     *   config file.
     */
    virtual void getElevatorBarHelperLetterTimeout(const std::shared_ptr<CommonAPI::ClientId> _client, getElevatorBarHelperLetterTimeoutReply_t _reply);
 ...
 */
virtual void fireSessionQueryUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_numResults, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr);
 ...
 */
virtual void fireThumbnailListUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const uint64_t &_startIndex, const uint64_t &_numItems, const std::vector<std::string> &_thumbnaiList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr);
virtual std::shared_ptr<CommonAPI::ClientIdList> const getSubscribersForThumbnailListUpdateSelective();
/// Hook method for reacting on new subscriptions or removed subscriptions respectively for selective broadcasts.
virtual void onThumbnailListUpdateSelectiveSubscriptionChanged(const std::shared_ptr<CommonAPI::ClientId> _client, const CommonAPI::SelectiveBroadcastSubscriptionEvent _event);
/// Hook method for reacting accepting or denying new subscriptions 
virtual bool onThumbnailListUpdateSelectiveSubscriptionRequested(const std::shared_ptr<CommonAPI::ClientId> _client);
/**
 * description: Publishes the query status to all clients. The client can get the data once the
 *   query is "finished" 	 	     returns  sessionID: 	   The Session ID alloted.   
 ...
 *   and their index
 */
virtual void fireSessionQueryAlphaJumpUpdateSelective(const uint32_t &_sessionID, const uint32_t &_sessionQueryID, const ::v3::com::harman::mmpres::MMPresTypes::arAlphaIndex &_ajList, const std::shared_ptr<CommonAPI::ClientIdList> _receivers = nullptr);
virtual std::shared_ptr<CommonAPI::ClientIdList> const getSubscribersForSessionQueryAlphaJumpUpdateSelective();
/// Hook method for reacting on new subscriptions or removed subscriptions respectively for selective broadcasts.
virtual void onSessionQueryAlphaJumpUpdateSelectiveSubscriptionChanged(const std::shared_ptr<CommonAPI::ClientId> _client, const CommonAPI::SelectiveBroadcastSubscriptionEvent _event);
/// Hook method for reacting accepting or denying new subscriptions 
virtual bool onSessionQueryAlphaJumpUpdateSelectiveSubscriptionRequested(const std::shared_ptr<CommonAPI::ClientId> _client);


protected:
    virtual bool trySetSearchCandidatesAttribute(std::vector<std::string> _value);
    virtual bool validateSearchCandidatesAttributeRequestedValue(const std::vector<std::string> &_value);
    virtual bool trySetItemIndexTobeHighlightedAttribute(::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap _value);
    virtual bool validateItemIndexTobeHighlightedAttributeRequestedValue(const ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap &_value);
    class RemoteEventHandler: public virtual MediaBrowserStubRemoteEvent {
    public:
        RemoteEventHandler(MediaBrowserStubDefault *_defaultStub);




    private:
        MediaBrowserStubDefault *defaultStub_;
    };
private:
    MediaBrowserStubDefault::RemoteEventHandler remoteEventHandler_;

    std::vector<std::string> searchCandidatesAttributeValue_ {};
    ::v3::com::harman::mmpres::MMPresTypes::HighlightItemIndexMap itemIndexTobeHighlightedAttributeValue_ {};
...
#endif // V3_COM_HARMAN_MMPRES_Media_Browser_STUB_DEFAULT
