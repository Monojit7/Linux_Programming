...
public:
     ...
     */
    /**
     * Returns the wrapper class that provides access to the attribute engExhMdeQuiet_D_Stat_enum.
     */
    virtual EngExhMdeQuiet_D_Stat_enumAttribute& getEngExhMdeQuiet_D_Stat_enumAttribute() {
        return delegate_->getEngExhMdeQuiet_D_Stat_enumAttribute();
    }
    /**
     * description: No Information Available
     */
    ...
    /**
     * Returns the wrapper class that provides access to the attribute gWM_Send_Signals_4_sig_0.
     */
    virtual GWM_Send_Signals_4_sig_0Attribute& getGWM_Send_Signals_4_sig_0Attribute() {
        return delegate_->getGWM_Send_Signals_4_sig_0Attribute();
    }
    /**
    ...
    /**
     * Returns the wrapper class that provides access to the attribute gWM_Send_Signals_2_sig_0.
     */
    virtual GWM_Send_Signals_2_sig_0Attribute& getGWM_Send_Signals_2_sig_0Attribute() {
        return delegate_->getGWM_Send_Signals_2_sig_0Attribute();
    }
    /**
     * Returns the wrapper class that provides access to the attribute gWM_Send_Signals_2_sig_1.
     */
    virtual GWM_Send_Signals_2_sig_1Attribute& getGWM_Send_Signals_2_sig_1Attribute() {
        return delegate_->getGWM_Send_Signals_2_sig_1Attribute();
    }
    /**
     * Returns the wrapper class that provides access to the attribute gWM_Send_Signals_2_sig_2.
     */
    virtual GWM_Send_Signals_2_sig_2Attribute& getGWM_Send_Signals_2_sig_2Attribute() {
        return delegate_->getGWM_Send_Signals_2_sig_2Attribute();
    }
    /**
     * Returns the wrapper class that provides access to the attribute gWM_Send_Signals_2_sig_3.
     */
    virtual GWM_Send_Signals_2_sig_3Attribute& getGWM_Send_Signals_2_sig_3Attribute() {
        return delegate_->getGWM_Send_Signals_2_sig_3Attribute();
    }
    /**
    ...
    /**
     * description: No Information Available
     * Calls FactoryReset_Rq_method with Fire&Forget semantics.
     * 
    * All const parameters are input parameters to this method.
     ...
     * will be set.
     */
    virtual void FactoryReset_Rq_method(const ::v0::org::harman::ford::bodycontroldata_types::FactoryReset_Rq_enum &_factoryReset_Rq_enum, CommonAPI::CallStatus &_internalCallStatus);
    /**
     * description: No Information Available
     * Calls TCU_ESN_D_Rq_method with Fire&Forget semantics.
     * 
    * All const parameters are input parameters to this method.
     * The CallStatus will be filled when the method returns and indicate either
     * "SUCCESS" or which type of error has occurred. In case of an error, ONLY the CallStatus
     * will be set.
     */
    virtual void TCU_ESN_D_Rq_method(const ::v0::org::harman::ford::bodycontroldata_types::TCU_ESN_D_Rq_enum &_tCU_ESN_D_Rq_enum, CommonAPI::CallStatus &_internalCallStatus);
...
namespace bodycontroldataExtensions {
     ...
     */
    template <template <typename > class _ExtensionType>
    class EngExhMdeQuiet_D_Stat_enumAttributeExtension {
     public:
        typedef _ExtensionType<bodycontroldataProxyBase::EngExhMdeQuiet_D_Stat_enumAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<bodycontroldataProxyBase::EngExhMdeQuiet_D_Stat_enumAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        EngExhMdeQuiet_D_Stat_enumAttributeExtension() {}
    #endif
    
        EngExhMdeQuiet_D_Stat_enumAttributeExtension(bodycontroldataProxyBase& proxy): attributeExtension_(proxy.getEngExhMdeQuiet_D_Stat_enumAttribute()) {
        }
    
        inline extension_type& getEngExhMdeQuiet_D_Stat_enumAttributeExtension() {
            return attributeExtension_;
        }
    ...
    template <template <typename > class _ExtensionType>
    class GWM_Send_Signals_4_sig_0AttributeExtension {
     public:
        typedef _ExtensionType<bodycontroldataProxyBase::GWM_Send_Signals_4_sig_0Attribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<bodycontroldataProxyBase::GWM_Send_Signals_4_sig_0Attribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        GWM_Send_Signals_4_sig_0AttributeExtension() {}
    #endif
    
        GWM_Send_Signals_4_sig_0AttributeExtension(bodycontroldataProxyBase& proxy): attributeExtension_(proxy.getGWM_Send_Signals_4_sig_0Attribute()) {
        }
    
        inline extension_type& getGWM_Send_Signals_4_sig_0AttributeExtension() {
            return attributeExtension_;
        }
    ...
    template <template <typename > class _ExtensionType>
    class GWM_Send_Signals_2_sig_0AttributeExtension {
     public:
        typedef _ExtensionType<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_0Attribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_0Attribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        GWM_Send_Signals_2_sig_0AttributeExtension() {}
    #endif
    
        GWM_Send_Signals_2_sig_0AttributeExtension(bodycontroldataProxyBase& proxy): attributeExtension_(proxy.getGWM_Send_Signals_2_sig_0Attribute()) {
        }
    
        inline extension_type& getGWM_Send_Signals_2_sig_0AttributeExtension() {
            return attributeExtension_;
        }
    ...
    template <template <typename > class _ExtensionType>
    class GWM_Send_Signals_2_sig_1AttributeExtension {
     public:
        typedef _ExtensionType<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_1Attribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_1Attribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        GWM_Send_Signals_2_sig_1AttributeExtension() {}
    #endif
    
        GWM_Send_Signals_2_sig_1AttributeExtension(bodycontroldataProxyBase& proxy): attributeExtension_(proxy.getGWM_Send_Signals_2_sig_1Attribute()) {
        }
    
        inline extension_type& getGWM_Send_Signals_2_sig_1AttributeExtension() {
            return attributeExtension_;
        }
    ...
    template <template <typename > class _ExtensionType>
    class GWM_Send_Signals_2_sig_2AttributeExtension {
     public:
        typedef _ExtensionType<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_2Attribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_2Attribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        GWM_Send_Signals_2_sig_2AttributeExtension() {}
    #endif
    
        GWM_Send_Signals_2_sig_2AttributeExtension(bodycontroldataProxyBase& proxy): attributeExtension_(proxy.getGWM_Send_Signals_2_sig_2Attribute()) {
        }
    
        inline extension_type& getGWM_Send_Signals_2_sig_2AttributeExtension() {
            return attributeExtension_;
        }
    ...
    template <template <typename > class _ExtensionType>
    class GWM_Send_Signals_2_sig_3AttributeExtension {
     public:
        typedef _ExtensionType<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_3Attribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<bodycontroldataProxyBase::GWM_Send_Signals_2_sig_3Attribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        GWM_Send_Signals_2_sig_3AttributeExtension() {}
    #endif
    
        GWM_Send_Signals_2_sig_3AttributeExtension(bodycontroldataProxyBase& proxy): attributeExtension_(proxy.getGWM_Send_Signals_2_sig_3Attribute()) {
        }
    
        inline extension_type& getGWM_Send_Signals_2_sig_3AttributeExtension() {
            return attributeExtension_;
        }
 ...
 */
template <typename ... _AttributeExtensions>
void bodycontroldataProxy<_AttributeExtensions...>::FactoryReset_Rq_method(const ::v0::org::harman::ford::bodycontroldata_types::FactoryReset_Rq_enum &_factoryReset_Rq_enum, CommonAPI::CallStatus &_internalCallStatus) {
    if (!_factoryReset_Rq_enum.validate()) {
        _internalCallStatus = CommonAPI::CallStatus::INVALID_VALUE;
        return;
    }
    delegate_->FactoryReset_Rq_method(_factoryReset_Rq_enum, _internalCallStatus);
}
/**
 * description: No Information Available
 */
template <typename ... _AttributeExtensions>
void bodycontroldataProxy<_AttributeExtensions...>::TCU_ESN_D_Rq_method(const ::v0::org::harman::ford::bodycontroldata_types::TCU_ESN_D_Rq_enum &_tCU_ESN_D_Rq_enum, CommonAPI::CallStatus &_internalCallStatus) {
    if (!_tCU_ESN_D_Rq_enum.validate()) {
        _internalCallStatus = CommonAPI::CallStatus::INVALID_VALUE;
        return;
    }
    delegate_->TCU_ESN_D_Rq_method(_tCU_ESN_D_Rq_enum, _internalCallStatus);
}
...
struct DefaultAttributeProxyHelper<::v0::org::harman::ford::bodycontroldataProxy,
    ...
    typedef typename ::v0::org::harman::ford::bodycontroldataProxy<
            ...
            ::v0::org::harman::ford::bodycontroldataExtensions::EngExhMdeQuiet_D_Stat_enumAttributeExtension<_AttributeExtension>, 
            ...
            ::v0::org::harman::ford::bodycontroldataExtensions::GWM_Send_Signals_4_sig_0AttributeExtension<_AttributeExtension>, 
            ::v0::org::harman::ford::bodycontroldataExtensions::Body_Info_1_HS3_sig_0AttributeExtension<_AttributeExtension>, 
            ::v0::org::harman::ford::bodycontroldataExtensions::GWM_Send_Signals_2_sig_0AttributeExtension<_AttributeExtension>, 
            ::v0::org::harman::ford::bodycontroldataExtensions::GWM_Send_Signals_2_sig_1AttributeExtension<_AttributeExtension>, 
            ::v0::org::harman::ford::bodycontroldataExtensions::GWM_Send_Signals_2_sig_2AttributeExtension<_AttributeExtension>, 
            ::v0::org::harman::ford::bodycontroldataExtensions::GWM_Send_Signals_2_sig_3AttributeExtension<_AttributeExtension>, 
