...
struct notifalert_types {
    ...
    struct AHU_Chime_Not_Recgnizd_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Inactive = 0,
            En_Chime_Not_Recognized = 1
        };
        
        AHU_Chime_Not_Recgnizd_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Inactive)) {}
        AHU_Chime_Not_Recgnizd_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::En_Inactive):
                case static_cast<int32_t>(Literal::En_Chime_Not_Recognized):
                return true;
            default:
                return false;
            }
        ...
        inline bool operator==(const AHU_Chime_Not_Recgnizd_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const AHU_Chime_Not_Recgnizd_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const AHU_Chime_Not_Recgnizd_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const AHU_Chime_Not_Recgnizd_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const AHU_Chime_Not_Recgnizd_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct AHU_Chime2_Not_Recgnizd_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Inactive = 0,
            En_Chime_Not_Recognized = 1
        };
        
        AHU_Chime2_Not_Recgnizd_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Inactive)) {}
        AHU_Chime2_Not_Recgnizd_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
        ...
        inline bool operator==(const AHU_Chime2_Not_Recgnizd_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const AHU_Chime2_Not_Recgnizd_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const AHU_Chime2_Not_Recgnizd_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const AHU_Chime2_Not_Recgnizd_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const AHU_Chime2_Not_Recgnizd_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct AHU_Chime_Active_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Chime_62 = 63,
            En_Chime_3 = 4,
            En_Chime_2 = 3,
        ...
        inline bool operator==(const AHU_Chime_Active_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const AHU_Chime_Active_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const AHU_Chime_Active_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const AHU_Chime_Active_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const AHU_Chime_Active_enum &_other) const { return (value_ < _other.value_); }
    ...
    struct AHU_Chime2_Active_enum : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            En_Chime_62 = 63,
            En_Chime_3 = 4,
            En_Chime_2 = 3,
        ...
        AHU_Chime2_Active_enum() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::En_Chime_62)) {}
        AHU_Chime2_Active_enum(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
        ...
        inline bool operator==(const AHU_Chime2_Active_enum &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const AHU_Chime2_Active_enum &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const AHU_Chime2_Active_enum &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const AHU_Chime2_Active_enum &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const AHU_Chime2_Active_enum &_other) const { return (value_ < _other.value_); }
...
namespace std {
    ...
    //Hash for AHU_Chime_Not_Recgnizd_enum
    template<>
    struct hash<::v0::org::harman::ford::notifalert_types::AHU_Chime_Not_Recgnizd_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::notifalert_types::AHU_Chime_Not_Recgnizd_enum& aHU_Chime_Not_Recgnizd_enum) const {
            return static_cast<int32_t>(aHU_Chime_Not_Recgnizd_enum);
        }
    };
    //Hash for AHU_Chime2_Not_Recgnizd_enum
    template<>
    struct hash<::v0::org::harman::ford::notifalert_types::AHU_Chime2_Not_Recgnizd_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::notifalert_types::AHU_Chime2_Not_Recgnizd_enum& aHU_Chime2_Not_Recgnizd_enum) const {
            return static_cast<int32_t>(aHU_Chime2_Not_Recgnizd_enum);
        }
    };
    ...
    //Hash for AHU_Chime_Active_enum
    template<>
    struct hash<::v0::org::harman::ford::notifalert_types::AHU_Chime_Active_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::notifalert_types::AHU_Chime_Active_enum& aHU_Chime_Active_enum) const {
            return static_cast<int32_t>(aHU_Chime_Active_enum);
        }
    };
    //Hash for AHU_Chime2_Active_enum
    template<>
    struct hash<::v0::org::harman::ford::notifalert_types::AHU_Chime2_Active_enum> {
        inline size_t operator()(const ::v0::org::harman::ford::notifalert_types::AHU_Chime2_Active_enum& aHU_Chime2_Active_enum) const {
            return static_cast<int32_t>(aHU_Chime2_Active_enum);
        }
    };
