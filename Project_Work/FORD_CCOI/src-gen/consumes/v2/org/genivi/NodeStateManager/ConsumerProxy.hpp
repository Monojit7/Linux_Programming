...
public:
     ...
     * description: NodeState:
    	   NodeState: Numeric value for the current NodeState, defined in
     *   NsmNodeState_e.
    
    	   Clients can register for notifications when the NodeState
     ...
     * description: NodeApplicationMode:
    	   ApplicationModeId: Numeric value for the current
     *   ApplicationMode, defined in NsmAplicationMode_e.
     ...
     * description: SessionStateChanged:
        	SessionStateName: The SessionName will be based upon
     *   either the pre-defined platform SessionNames or using a newly added product
     *   defined session name.
        	SeatID:           This parameter will be based upon
     *   the enum NsmSeat_e.
        	SessionState:     This parameter will be based upon
     ...
     * description: ShutdownEvent:
        	Request: Shutdown mode on which client will be informed
     *   (NSM_SHUTDOWNTYPE_NORMAL, NSM_SHUTDOWNTYPE_FAST).
       
         	Selective
     *   broadcast of shutdown request to registered clients
        	This signal is sent
     *   to registered clients when shutdown state is received
    		Note:LifeCycleRequest
