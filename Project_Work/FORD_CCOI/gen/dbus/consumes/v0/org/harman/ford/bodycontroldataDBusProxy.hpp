...
private:
    ...
    class DBusengExhMdeQuiet_D_Stat_enum_Attribute : public CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<EngExhMdeQuiet_D_Stat_enumAttribute>> {
    public:
    template <typename... _A>
    	DBusengExhMdeQuiet_D_Stat_enum_Attribute(DBusProxy &_proxy,
    		_A ... arguments)
    		: CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<EngExhMdeQuiet_D_Stat_enumAttribute>>(
    			_proxy, arguments...) {}
    };
    DBusengExhMdeQuiet_D_Stat_enum_Attribute engExhMdeQuiet_D_Stat_enum_;
    ...
    CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<GWM_Send_Signals_4_sig_0Attribute, ::v0::org::harman::ford::bodycontroldata_types_::GWM_Send_Signals_4_sig_0_structDeployment_t>> gWM_Send_Signals_4_sig_0_;
    ...
    CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<GWM_Send_Signals_2_sig_0Attribute, ::v0::org::harman::ford::bodycontroldata_types_::GWM_Send_Signals_2_sig_0_structDeployment_t>> gWM_Send_Signals_2_sig_0_;
    CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<GWM_Send_Signals_2_sig_1Attribute, ::v0::org::harman::ford::bodycontroldata_types_::GWM_Send_Signals_2_sig_1_structDeployment_t>> gWM_Send_Signals_2_sig_1_;
    CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<GWM_Send_Signals_2_sig_2Attribute, ::v0::org::harman::ford::bodycontroldata_types_::GWM_Send_Signals_2_sig_2_structDeployment_t>> gWM_Send_Signals_2_sig_2_;
    CommonAPI::DBus::DBusObservableAttribute<CommonAPI::DBus::DBusReadonlyAttribute<GWM_Send_Signals_2_sig_3Attribute, ::v0::org::harman::ford::bodycontroldata_types_::GWM_Send_Signals_2_sig_3_structDeployment_t>> gWM_Send_Signals_2_sig_3_;
